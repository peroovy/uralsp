/*! xlsx.js (C) 2013-present SheetJS -- http://sheetjs.com */ var Kt = {};
Kt.version = "0.18.5";
var $n = 1252,
    Xi = [874, 932, 936, 949, 950, 1250, 1251, 1252, 1253, 1254, 1255, 1256, 1257, 1258, 1e4],
    jn = function (e) {
        Xi.indexOf(e) != -1 && ($n = e);
    };
function Ki() {
...
function ji(e) {
    for (var t = [], r = 0, n = e.length + 250, a = Vr(e.length + 255), i = 0; i < e.length; ++i) {
        ...
        } else (a[r++] = 224 | ((s >> 12) & 15)), (a[r++] = 128 | ((s >> 6) & 63)), (a[r++] = 128 | (s & 63));
...
function $t(e, t, r) {
    for (var n = e < 0 ? -1 : 1, a = e * n, i = 0, s = 1, f = 0, o = 1, l = 0, c = 0, p = Math.floor(a); l < t && ((p = Math.floor(a)), (f = p * s + i), (c = p * l + o), !(a - p < 5e-8)); )
...
function bt(e, t, r) {
    ...
    if ((Math.abs(f.u) < 1e-6 && (f.u = 0), t && t.date1904 && (n += 1462), f.u > 0.9999 && ((f.u = 0), ++a == 86400 && ((f.T = a = 0), ++n, ++f.D)), n === 60))
        ...
        o.setDate(o.getDate() + n - 1), (s = [o.getFullYear(), o.getMonth() + 1, o.getDate()]), (i = o.getDay()), n < 60 && (i = (i + 6) % 7), r && (i = ss(o, s));
    }
...
function Zn(e, t) {
    var r = e.getTime();
    return t ? (r -= 1461 * 24 * 60 * 60 * 1e3) : e >= rs && (r += 24 * 60 * 60 * 1e3), (r - (es + (e.getTimezoneOffset() - Jn.getTimezoneOffset()) * 6e4)) / (24 * 60 * 60 * 1e3);
}
function I0(e) {
...
function is(e) {
    var t = Math.floor(Math.log(Math.abs(e)) * Math.LOG10E),
        r;
    return t >= -4 && t <= -1 ? (r = e.toPrecision(10 + t)) : Math.abs(t) <= 9 ? (r = ns(e)) : t === 10 ? (r = e.toFixed(10).substr(0, 12)) : (r = as(e)), I0(ts(r.toUpperCase()));
}
function y0(e, t) {
    switch (typeof e) {
        case "string":
        ...
        case "boolean":
            return e ? "TRUE" : "FALSE";
        case "number":
            return (e | 0) === e ? e.toString(10) : is(e);
        case "undefined":
            return "";
        case "object":
            if (e == null) return "";
            if (e instanceof Date) return kr(14, Zn(e, t && t.date1904), t);
    }
        ...
        case 115:
            ...
            return r.u === 0 && (t == "s" || t == "ss")
                ...
                : (n >= 2 ? (s = n === 3 ? 1e3 : 100) : (s = n === 1 ? 10 : 1),
                  ...
                  i >= 60 * s && (i = 0),
                  t === "s" ? (i === 0 ? "0" : "" + i / s) : ((a = vr(i, 2 + n)), t === "ss" ? a.substr(0, 2) : "." + a.substr(2, t.length - 1)));
        case 90:
            switch (t) {
                case "[h]":
                case "[hh]":
...
function Qn(e, t) {
    ...
    return (
        e.match(/E\+00$/) && r.match(/e[+-]\d$/) && (r = r.substr(0, r.length - 1) + "0" + r.charAt(r.length - 1)), e.match(/E\-/) && r.match(/e\+/) && (r = r.replace(/e\+/, "e")), r.replace("e", "E")
    );
}
var ea = /# (\?+)( ?)\/( ?)(\d+)/;
function cs(e, t, r) {
...
function fr(e, t, r) {
    ...
    if (t.charCodeAt(t.length - 1) === 44) return os(e, t, r);
    ...
    if (t.match(/^[#?]+$/)) return (a = qr(r, 0)), a === "0" && (a = ""), a.length > t.length ? a : Ye(t.substr(0, t.length - a.length)) + a;
    ...
    if ((i = t.match(/^#,##0\.([#0]*0)$/))) return r < 0 ? "-" + fr(e, t, -r) : Nr("" + (Math.floor(r) + us(r, i[1].length))) + "." + vr(vn(r, i[1].length), i[1].length);
    ...
    if ((i = t.match(/^([0#]+)(\\?-([0#]+))+$/)))
        return (
            ...
            (s = 0),
            nt(
                nt(t.replace(/\\/g, "")).replace(/[0#]/g, function (E) {
                    return s < a.length ? a.charAt(s++) : E === "0" ? "0" : "";
                })
            )
        );
    if (t.match(na)) return (a = fr(e, "##########", r)), "(" + a.substr(0, 3) + ") " + a.substr(3, 3) + "-" + a.substr(6);
    var c = "";
    if ((i = t.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/)))
        return (
            (s = Math.min(i[4].length, 7)),
            (f = $t(o, Math.pow(10, s) - 1, !1)),
            (a = "" + l),
            (c = Ar("n", i[1], f[1])),
    ...
    if ((i = t.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/)))
        return (
            ...
            (f = $t(o, Math.pow(10, s) - 1, !0)),
            l + (f[0] || (f[1] ? "" : "0")) + " " + (f[1] ? R0(f[1], s) + i[2] + "/" + i[3] + zt(f[2], s) : Fe(" ", 2 * s + 1 + i[2].length + i[3].length))
        );
    if ((i = t.match(/^[#0?]+$/))) return (a = qr(r, 0)), t.length <= a.length ? a : Ye(t.substr(0, t.length - a.length)) + a;
    if ((i = t.match(/^([#0?]+)\.([#0]+)$/))) {
        (a = "" + r.toFixed(Math.min(i[2].length, 10)).replace(/([^0])0+$/, "$1")), (s = a.indexOf("."));
        var p = t.indexOf(".") - s,
            x = t.length - a.length - p;
        return Ye(t.substr(0, p) + a + t.substr(t.length - x));
    }
...
function mr(e, t, r) {
    ...
    if (t.match(/^[#?]+$/)) return (a = "" + r), r === 0 && (a = ""), a.length > t.length ? a : Ye(t.substr(0, t.length - a.length)) + a;
    if ((i = t.match(ea))) return hs(i, o, l);
    ...
    if ((i = t.match(/^#,##0\.([#0]*0)$/))) return r < 0 ? "-" + mr(e, t, -r) : Nr("" + r) + "." + Fe("0", i[1].length);
    ...
    if (t.match(na)) return (a = mr(e, "##########", r)), "(" + a.substr(0, 3) + ") " + a.substr(3, 3) + "-" + a.substr(6);
    var c = "";
    if ((i = t.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/)))
        return (
            (s = Math.min(i[4].length, 7)),
    ...
    if ((i = t.match(/^[#0?]+$/))) return (a = "" + r), t.length <= a.length ? a : Ye(t.substr(0, t.length - a.length)) + a;
    if ((i = t.match(/^([#0]+)\.([#0]+)$/))) {
        (a = "" + r.toFixed(Math.min(i[2].length, 10)).replace(/([^0])0+$/, "$1")), (s = a.indexOf("."));
        var p = t.indexOf(".") - s,
            x = t.length - a.length - p;
...
function ms(e, t, r, n) {
        ...
        switch ((f = e.charAt(s))) {
            ...
            case "b":
                if (e.charAt(s + 1) === "1" || e.charAt(s + 1) === "2") {
                    if (l == null && ((l = bt(t, r, e.charAt(s + 1) === "2")), l == null)) return "";
            ...
            case "e":
            case "g":
                if (t < 0 || (l == null && ((l = bt(t, r)), l == null))) return "";
            ...
            case "[":
                ...
                if (i.match(ia)) {
                    if (l == null && ((l = bt(t, r)), l == null)) return "";
    ...
    for (s = 0; s < a.length; ++s)
        switch (a[s].t) {
            ...
            case "b":
            case "Z":
                (a[s].v = fs(a[s].t.charCodeAt(0), a[s].v, l, O)), (a[s].t = "t");
                break;
            case "n":
            case "?":
                for (
                    ...
                    ((f = a[M].t) === "?" ||
                        f === "D" ||
                        ((f === " " || f === "t") && a[M + 1] != null && (a[M + 1].t === "?" || (a[M + 1].t === "t" && a[M + 1].v === "/"))) ||
                        (a[s].t === "(" && (f === " " || f === "n" || f === ")")) ||
                        (f === "t" && (a[M].v === "/" || (a[M].v === " " && a[M + 1] != null && a[M + 1].t == "?"))));
    ...
    if (y.length > 0) {
        y.charCodeAt(0) == 40
            ...
            : ((ee = t < 0 && n > 1 ? -t : t), (C = Ar("n", y, ee)), ee < 0 && a[0] && a[0].t == "t" && ((C = C.substr(1)), (a[0].v = "-" + a[0].v))),
            (M = C.length - 1);
        var b = a.length;
        for (s = 0; s < a.length; ++s)
        ...
        if (b === a.length && C.indexOf("E") === -1) {
            for (s = a.length - 1; s >= 0; --s)
                a[s] == null ||
                    "n?".indexOf(a[s].t) === -1 ||
                    (M >= a[s].v.length - 1 ? ((M -= a[s].v.length), (a[s].v = C.substr(M + 1, a[s].v.length))) : M < 0 ? (a[s].v = "") : ((a[s].v = C.substr(0, M + 1)), (M = -1)),
                    (a[s].t = "t"),
                    (L = s));
            ...
            for (M >= 0 && L < a.length && (a[L].v = C.substr(0, M + 1) + a[L].v), M = C.indexOf(".") + 1, s = b; s < a.length; ++s)
                if (!(a[s] == null || ("n?(".indexOf(a[s].t) === -1 && s !== b))) {
                    for (c = a[s].v.indexOf(".") > -1 && s === b ? a[s].v.indexOf(".") + 1 : 0, j = a[s].v.substr(0, c); c < a[s].v.length; ++c) M < C.length && (j += C.charAt(M++));
                    (a[s].v = j), (a[s].t = "t"), (L = s);
                }
        }
    }
    for (s = 0; s < a.length; ++s) a[s] != null && "n?".indexOf(a[s].t) > -1 && ((ee = n > 1 && t < 0 && s > 0 && a[s - 1].v === "-" ? -t : t), (a[s].v = Ar(a[s].t, a[s].v, ee)), (a[s].t = "t"));
    var G = "";
...
function gs(e, t) {
    ...
    if (r[0].match(/\[[=<>]/) != null || r[1].match(/\[[=<>]/) != null) {
        var s = r[0].match(pn),
            f = r[1].match(pn);
        return dn(t, s) ? [n, r[0]] : dn(t, f) ? [n, r[1]] : [n, r[s != null && f != null ? 2 : 1]];
    }
    return [n, i];
}
function kr(e, t, r) {
...
function s0(e) {
    for (var t = 0; t != 392; ++t) e[t] !== void 0 && fa(e[t], t);
}
function f0() {
    ye = qi();
}
...
function Ts(e, t, r) {
    var n = -1,
        ...
        f = -1,
        o = -1;
    (t.match(la) || []).forEach(function (p, x) {
...
var Es = (function () {
        ...
        function n(C) {
            ...
            for (G = 0; G != 256; ++G) for (L = C[G], b = 256 + G; b < 4096; b += 256) L = V[b] = (L >>> 8) ^ C[L & 255];
            var K = [];
            ...
            for (var L = b ^ -1, G = 0, V = C.length, K = 0, re = 0; G < V; )
                (K = C.charCodeAt(G++)),
                    K < 128
                        ? (L = (L >>> 8) ^ r[(L ^ K) & 255])
                        : K < 2048
                        ? ((L = (L >>> 8) ^ r[(L ^ (192 | ((K >> 6) & 31))) & 255]), (L = (L >>> 8) ^ r[(L ^ (128 | (K & 63))) & 255]))
                        : K >= 55296 && K < 57344
                        ? ((K = (K & 1023) + 64),
                          (re = C.charCodeAt(G++) & 1023),
                          (L = (L >>> 8) ^ r[(L ^ (240 | ((K >> 8) & 7))) & 255]),
                          (L = (L >>> 8) ^ r[(L ^ (128 | ((K >> 2) & 63))) & 255]),
                          (L = (L >>> 8) ^ r[(L ^ (128 | ((re >> 6) & 15) | ((K & 3) << 4))) & 255]),
                          (L = (L >>> 8) ^ r[(L ^ (128 | (re & 63))) & 255]))
                        : ((L = (L >>> 8) ^ r[(L ^ (224 | ((K >> 12) & 15))) & 255]), (L = (L >>> 8) ^ r[(L ^ (128 | ((K >> 6) & 63))) & 255]), (L = (L >>> 8) ^ r[(L ^ (128 | (K & 63))) & 255]));
            return ~L;
        }
    ...
    _e = (function () {
        ...
        t.version = "1.2.1";
        function r(h, g) {
            for (var d = h.split("/"), m = g.split("/"), T = 0, w = 0, I = Math.min(d.length, m.length); T < I; ++T) {
                if ((w = d[T].length - m[T].length)) return w;
                if (d[T] != m[T]) return d[T] < m[T] ? -1 : 1;
            }
        ...
        function i(h, g) {
            ...
            var d = g.getHours();
            (d = (d << 6) | g.getMinutes()), (d = (d << 5) | (g.getSeconds() >>> 1)), h.write_shift(2, d);
        ...
        function s(h) {
            ...
            d >>>= 5;
            var w = d & 15;
            (d >>>= 4), m.setMilliseconds(0), m.setFullYear(d + 1980), m.setMonth(w - 1), m.setDate(T);
            var I = g & 31;
            g >>>= 5;
            var U = g & 63;
                ...
                switch (m) {
                    case 21589:
                        (d = h.read_shift(1)),
                            ...
                            T > 5 && (d & 2 && (I.atime = h.read_shift(4)), d & 4 && (I.ctime = h.read_shift(4))),
        ...
        function c(h, g) {
            if (h[0] == 80 && h[1] == 75) return fn(h, g);
            if ((h[0] | 32) == 109 && (h[1] | 32) == 105) return Ui(h, g);
            ...
            if (d === 3 && te !== 0) throw new Error("# Directory Sectors: Expected 0 saw " + te);
            (k.l += 4),
                (I = k.read_shift(4, "i")),
                (k.l += 4),
                ...
                (D = k.read_shift(4, "i")),
                (w = k.read_shift(4, "i"));
            for (var z = -1, Q = 0; Q < 109 && ((z = k.read_shift(4, "i")), !(z < 0)); ++Q) N[Q] = z;
            var fe = v(h, m);
            _(D, w, fe, m, N);
            var we = R(fe, I, N, m);
            (we[I].name = "!Directory"), T > 0 && U !== re && (we[U].name = "!MiniFAT"), (we[N[0]].name = "!FAT"), (we.fat_addrs = N), (we.ssz = m);
            var Se = {},
                Ve = [],
                ut = [],
                xt = [];
            y(I, we, fe, Ve, T, Se, ut, U), E(ut, xt, Ve), Ve.shift();
        ...
        function v(h, g) {
            for (var d = Math.ceil(h.length / g) - 1, m = [], T = 1; T < d; ++T) m[T - 1] = h.slice(T * g, (T + 1) * g);
            return (m[d - 1] = h.slice(d * g)), m;
        }
        function E(h, g, d) {
            for (var m = 0, T = 0, w = 0, I = 0, U = 0, D = d.length, N = [], k = []; m < D; ++m) (N[m] = k[m] = m), (g[m] = d[m]);
            for (; U < k.length; ++U)
                (m = k[U]),
                    (T = h[m].L),
                    (w = h[m].R),
                    (I = h[m].C),
                    N[m] === m && (T !== -1 && N[T] !== T && (N[m] = N[T]), w !== -1 && N[w] !== w && (N[m] = N[w])),
                    I !== -1 && (N[I] = m),
                    T !== -1 && m != N[m] && ((N[T] = N[m]), k.lastIndexOf(T) < U && k.push(T)),
                    w !== -1 && m != N[m] && ((N[w] = N[m]), k.lastIndexOf(w) < U && k.push(w));
            for (m = 1; m < D; ++m) N[m] === m && (w !== -1 && N[w] !== w ? (N[m] = N[w]) : T !== -1 && N[T] !== T && (N[m] = N[T]));
            for (m = 1; m < D; ++m)
                if (h[m].type !== 0) {
                    if (((U = m), U != N[U]))
        ...
        function u(h, g, d) {
            for (var m = h.start, T = h.size, w = [], I = m; d && T > 0 && I >= 0; ) w.push(g.slice(I * K, I * K + K)), (T -= K), (I = Hr(d, I * 4));
            return w.length === 0 ? B(0) : be(w).slice(0, h.size);
        }
        function _(h, g, d, m, T) {
            var w = re;
            if (h === re) {
                ...
                var I = d[h],
                    U = (m >>> 2) - 1;
                if (!I) return;
                for (var D = 0; D < U && (w = Hr(I, D * 4)) !== re; ++D) T.push(w);
                _(Hr(I, m - 4), g - 1, d, m, T);
            }
        }
        function O(h, g, d, m, T) {
            var w = [],
                I = [];
            T || (T = []);
            var U = m - 1,
            ...
            for (D = g; D >= 0; ) {
                ...
                if (((N = (D * 4) & U), m < 4 + N)) throw new Error("FAT boundary crossed: " + D + " 4 " + m);
                if (!h[k]) break;
                D = Hr(h[k], N);
            }
            ...
            for (k = 0; k < T; ++k)
                if (((U = []), (Z = k + g), Z >= T && (Z -= T), !I[Z])) {
                    ...
                    for (X = Z; X >= 0; ) {
                        ...
                        if (((te = (X * 4) & N), m < 4 + te)) throw new Error("FAT boundary crossed: " + X + " 4 " + m);
        ...
        function y(h, g, d, m, T, w, I, U) {
            for (var D = 0, N = m.length ? 2 : 0, k = g[h].data, X = 0, Z = 0, te; X < k.length; X += 128) {
                var z = k.slice(X, X + 128);
                rr(z, 64), (Z = z.read_shift(2)), (te = M0(z, 0, Z - N)), m.push(te);
                var Q = {
                        name: te,
                        type: z.read_shift(1),
                ...
                we !== 0 && (Q.mt = M(z, z.l - 8)),
                    ...
                    Q.type === 5
                        ...
                        : Q.size >= 4096
                        ? ((Q.storage = "fat"), g[Q.start] === void 0 && (g[Q.start] = O(d, Q.start, g.fat_addrs, g.ssz)), (g[Q.start].name = Q.name), (Q.content = g[Q.start].data.slice(0, Q.size)))
                        : ((Q.storage = "minifat"), Q.size < 0 ? (Q.size = 0) : D !== re && Q.start !== re && g[D] && (Q.content = u(Q, g[D].data, (g[U] || {}).data))),
        ...
        function ee(h, g) {
            var d = g && g.type;
            switch ((d || (ue && Buffer.isBuffer(h) && (d = "buffer")), d || "base64")) {
                case "file":
                    return j(h, g);
                case "base64":
                    return c(xr(Cr(h)), g);
        ...
        function C(h, g) {
            ...
            h.FullPaths.length === 0 && ((h.FullPaths[0] = m + "/"), (h.FileIndex[0] = { name: m, type: 5 })), d.CLSID && (h.FileIndex[0].clsid = d.CLSID), b(h);
        }
        function b(h) {
            var g = "Sh33tJ5";
            if (!_e.find(h, "/" + g)) {
        ...
        function L(h, g) {
            C(h);
            for (var d = !1, m = !1, T = h.FullPaths.length - 1; T >= 0; --T) {
                var w = h.FileIndex[T];
                switch (w.type) {
                    case 0:
                    ...
                    case 2:
                    case 5:
                        (m = !0), isNaN(w.R * w.L * w.C) && (d = !0), w.R > -1 && w.L > -1 && w.R == w.L && (d = !0);
                        break;
                    default:
                        d = !0;
                        break;
            ...
            if (!(!d && !g)) {
                var I = new Date(1987, 1, 19),
                    ...
                    N = [];
                for (T = 0; T < h.FullPaths.length; ++T) (D[h.FullPaths[T]] = !0), h.FileIndex[T].type !== 0 && N.push([h.FullPaths[T], h.FileIndex[T]]);
        ...
        function G(h, g) {
            var d = g || {};
            if (d.fileType == "mad") return bi(h, d);
            ...
            var m = (function (te) {
                    ...
                    for (
                        var Ve = (te.FullPaths.length + 3) >> 2, ut = (z + 7) >> 3, xt = (z + 127) >> 7, vt = ut + Q + Ve + xt, br = (vt + 127) >> 7, m0 = br <= 109 ? 0 : Math.ceil((br - 109) / 127);
                        (vt + br + m0 + 127) >> 7 > br;

                    )
                        m0 = ++br <= 109 ? 0 : Math.ceil((br - 109) / 127);
                    var wr = [1, m0, br, xt, Ve, Q, z, 0];
            ...
            U(m[3]), U(m[4]);
            for (var D = 0, N = 0, k = h.FileIndex[0]; D < h.FileIndex.length; ++D) (k = h.FileIndex[D]), k.content && ((N = k.content.length), !(N < 4096) && ((k.start = I), U((N + 511) >> 9)));
            for (U((m[6] + 7) >> 3); T.l & 511; ) T.write_shift(-4, Ce.ENDOFCHAIN);
            for (I = w = 0, D = 0; D < h.FileIndex.length; ++D) (k = h.FileIndex[D]), k.content && ((N = k.content.length), !(!N || N >= 4096) && ((k.start = I), U((N + 63) >> 6)));
            ...
            for (w = 1; w < h.FileIndex.length; ++w)
                if (((k = h.FileIndex[w]), k.size >= 4096))
                    if (((T.l = (k.start + 1) << 9), ue && Buffer.isBuffer(k.content))) k.content.copy(T, T.l, 0, k.size), (T.l += (k.size + 511) & -512);
                    else {
            ...
            for (w = 1; w < h.FileIndex.length; ++w)
                if (((k = h.FileIndex[w]), k.size > 0 && k.size < 4096))
                    if (ue && Buffer.isBuffer(k.content)) k.content.copy(T, T.l, 0, k.size), (T.l += (k.size + 63) & -64);
                    else {
                        for (D = 0; D < k.size; ++D) T.write_shift(1, k.content[D]);
        ...
        function V(h, g) {
            var d = h.FullPaths.map(function (D) {
                ...
                T = !1;
            g.charCodeAt(0) === 47 ? ((T = !0), (g = d[0].slice(0, -1) + g)) : (T = g.indexOf("/") !== -1);
            var w = g.toUpperCase(),
                I = T === !0 ? d.indexOf(w) : m.indexOf(w);
            if (I !== -1) return h.FileIndex[I];
            var U = !w.match(Ut);
            for (w = w.replace(mt, ""), U && (w = w.replace(Ut, "!")), I = 0; I < d.length; ++I)
                if ((U ? d[I].replace(Ut, "!") : d[I]).replace(mt, "") == w || (U ? m[I].replace(Ut, "!") : m[I]).replace(mt, "") == w) return h.FileIndex[I];
            return null;
        }
        var K = 64,
            re = -2,
        ...
        function Ne(h) {
            for (var g = new Array(h.length), d = 0; d < h.length; ++d) g[d] = String.fromCharCode(h[d]);
            return g.join("");
        }
        function ir(h, g) {
            var d = G(h, g);
            switch ((g && g.type) || "buffer") {
                ...
                case "base64":
                    return At(typeof d == "string" ? d : Ne(d));
                case "buffer":
        ...
        function S(h) {
            try {
                var g = h.InflateRaw,
                    d = new g();
                if ((d._processChunk(new Uint8Array([3, 0]), d._finishFlushFlag), d.bytesRead)) Qe = h;
        ...
        var A = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15],
            H = [3, 4, 5, 6, 7, 8, 9, 10, 11, 13, 15, 17, 19, 23, 27, 31, 35, 43, 51, 59, 67, 83, 99, 115, 131, 163, 195, 227, 258],
            ie = [1, 2, 3, 4, 5, 7, 9, 13, 17, 25, 33, 49, 65, 97, 129, 193, 257, 385, 513, 769, 1025, 1537, 2049, 3073, 4097, 6145, 8193, 12289, 16385, 24577];
        function se(h) {
            var g = (((h << 1) | (h << 11)) & 139536) | (((h << 5) | (h << 15)) & 558144);
            return ((g >> 16) | (g >> 8) | g) & 255;
        }
        for (var ae = typeof Uint8Array < "u", q = ae ? new Uint8Array(1 << 8) : [], Te = 0; Te < 1 << 8; ++Te) q[Te] = se(Te);
        function ce(h, g) {
            var d = q[h & 255];
            return g <= 8 ? d >>> (8 - g) : ((d = (d << 8) | q[(h >> 8) & 255]), g <= 16 ? d >>> (16 - g) : ((d = (d << 8) | q[(h >> 16) & 255]), d >>> (24 - g)));
        }
        function ze(h, g) {
            var d = g & 7,
                m = g >>> 3;
        ...
        function sr(h, g, d) {
            var m = g & 7,
                ...
                w = (1 << d) - 1,
                I = h[T] >>> m;
            return d < 8 - m || ((I |= h[T + 1] << (8 - m)), d < 16 - m) || ((I |= h[T + 2] << (16 - m)), d < 24 - m) || (I |= h[T + 3] << (24 - m)), I & w;
        }
        function Er(h, g, d) {
            var m = g & 7,
                T = g >>> 3;
            return m <= 5 ? (h[T] |= (d & 7) << m) : ((h[T] |= (d << m) & 255), (h[T + 1] = (d & 7) >> (8 - m))), g + 3;
        }
        function Br(h, g, d) {
            var m = g & 7,
                T = g >>> 3;
            return (d = (d & 1) << m), (h[T] |= d), g + 1;
        }
        function Zr(h, g, d) {
            var m = g & 7,
                T = g >>> 3;
            return (d <<= m), (h[T] |= d & 255), (d >>>= 8), (h[T + 1] = d), g + 8;
        }
        function Z0(h, g, d) {
            var m = g & 7,
                T = g >>> 3;
            return (d <<= m), (h[T] |= d & 255), (d >>>= 8), (h[T + 1] = d & 255), (h[T + 2] = d >>> 8), g + 16;
        }
        function x0(h, g) {
            var d = h.length,
                m = 2 * d > g ? 2 * d : g + 5,
        ...
        function Lt(h, g, d) {
            ...
            var X = 0;
            for (w = 0; w < D; ++w) if (((X = h[w]), X != 0)) for (U = ce(k[w], m) >> (m - X), I = (1 << (m + 4 - X)) - 1; I >= 0; --I) g[U | (I << X)] = (X & 15) | (w << 4);
            return m;
        }
        var v0 = ae ? new Uint16Array(512) : dr(512),
            p0 = ae ? new Uint16Array(32) : dr(32);
        if (!ae) {
            for (var Ur = 0; Ur < 512; ++Ur) v0[Ur] = 0;
            for (Ur = 0; Ur < 32; ++Ur) p0[Ur] = 0;
        }
        (function () {
        ...
        var Oi = (function () {
            for (var g = ae ? new Uint8Array(32768) : [], d = 0, m = 0; d < ie.length - 1; ++d) for (; m < ie[d + 1]; ++m) g[m] = d;
            for (; m < 32768; ++m) g[m] = 29;
            var T = ae ? new Uint8Array(259) : [];
            for (d = 0, m = 0; d < H.length - 1; ++d) for (; m < H[d + 1]; ++m) T[m] = d;
            function w(U, D) {
            ...
            function I(U, D) {
                for (var N = 0, k = 0, X = ae ? new Uint16Array(32768) : []; k < U.length; ) {
                    ...
                    for (var te = 0; Z-- > 0; ) {
                        ...
                        var Q = -1,
                            fe = 0;
                        if ((Q = X[te]) && ((Q |= k & -32768), Q > k && (Q -= 32768), Q < k)) for (; U[Q + fe] == U[k + fe] && fe < 250; ) ++fe;
                        if (fe > 2) {
                            (z = T[fe]), z <= 22 ? (N = Zr(D, N, q[z + 1] >> 1) - 1) : (Zr(D, N, 3), (N += 5), Zr(D, N, q[z - 23] >> 5), (N += 3));
                            var we = z < 8 ? 0 : (z - 4) >> 2;
                            we > 0 && (Z0(D, N, fe - H[z]), (N += we)), (z = g[k - Q]), (N = Zr(D, N, q[z] >> 3)), (N -= 3);
                            var Se = z < 4 ? 0 : (z - 2) >> 1;
                            Se > 0 && (Z0(D, N, k - Q - ie[z]), (N += Se));
                            for (var Ve = 0; Ve < fe; ++Ve) (X[te] = k & 32767), (te = ((te << 5) ^ U[k]) & 32767), ++k;
                            Z -= fe - 1;
                        } else z <= 143 ? (z = z + 48) : (N = Br(D, N, 1)), (N = Zr(D, N, q[z])), (X[te] = k & 32767), ++k;
                    }
                    N = Zr(D, N, 0) - 1;
                }
        ...
        var Q0 = ae ? new Uint16Array(32768) : dr(32768),
            en = ae ? new Uint16Array(32768) : dr(32768),
            rn = ae ? new Uint16Array(128) : dr(128),
            tn = 1,
            nn = 1;
        function Di(h, g) {
            var d = Ae(h, g) + 257;
            ...
            for (D = 1; fe.length < d + m; )
                switch (((te = rn[ne(h, g)]), (g += te & 7), (te >>>= 3))) {
                    case 16:
                        for (w = 3 + ze(h, g), g += 2, te = fe[fe.length - 1]; w-- > 0; ) fe.push(te);
                        break;
                    case 17:
            ...
            return (tn = Lt(we, Q0, 286)), (nn = Lt(Se, en, 30)), g;
        }
        function Ri(h, g) {
            if (h[0] == 3 && !(h[1] & 3)) return [Vr(g), 2];
            for (var d = 0, m = 0, T = on(g || 1 << 18), w = 0, I = T.length >>> 0, U = 0, D = 0; (m & 1) == 0; ) {
                if (((m = xe(h, d)), (d += 3), m >>> 1 == 0)) {
                    d & 7 && (d += 8 - (d & 7));
                    var N = h[d >>> 3] | (h[(d >>> 3) + 1] << 8);
                    if (((d += 32), N > 0)) for (!g && I < w + N && ((T = x0(T, w + N)), (I = T.length)); N-- > 0; ) (T[w++] = h[d >>> 3]), (d += 8);
                    continue;
                } else m >> 1 == 1 ? ((U = 9), (D = 5)) : ((d = Di(h, d)), (U = tn), (D = nn));
                for (;;) {
                    !g && I < w + 32767 && ((T = x0(T, w + 32767)), (I = T.length));
                    var k = sr(h, d, U),
                        X = m >>> 1 == 1 ? v0[k] : Q0[k];
                    if (((d += X & 15), (X >>>= 4), ((X >>> 8) & 255) === 0)) T[w++] = X;
                    else {
                        if (X == 256) break;
                        X -= 257;
                        var Z = X < 8 ? 0 : (X - 4) >> 2;
                        Z > 5 && (Z = 0);
                        var te = w + H[X];
                        Z > 0 && ((te += sr(h, d, Z)), (d += Z)), (k = sr(h, d, D)), (X = m >>> 1 == 1 ? p0[k] : en[k]), (d += X & 15), (X >>>= 4);
                        var z = X < 4 ? 0 : (X - 2) >> 1,
                            Q = ie[X];
                        for (z > 0 && ((Q += sr(h, d, z)), (d += z)), !g && I < te && ((T = x0(T, te + 100)), (I = T.length)); w < te; ) (T[w] = T[w - Q]), ++w;
                    }
                }
            }
            return g ? [T, (d + 7) >>> 3] : [T.slice(0, w), (d + 7) >>> 3];
        }
        function an(h, g) {
            var d = h.slice(h.l || 0),
                m = Ri(d, g);
        ...
        function fn(h, g) {
            ...
            C(w, { root: g.root });
            for (var I = d.length - 4; (d[I] != 80 || d[I + 1] != 75 || d[I + 2] != 5 || d[I + 3] != 6) && I >= 0; ) --I;
            (d.l = I + 4), (d.l += 4);
            ...
            for (d.l = D, I = 0; I < U; ++I) {
                ...
                d.l += X + Z + te;
                var fe = d.l;
                (d.l = z + 4), Ii(d, N, k, w, Q), (d.l = fe);
            }
            return w;
        }
        function Ii(h, g, d, m, T) {
            h.l += 2;
            ...
            var we = !1;
            w & 8 && ((D = h.read_shift(4)), D == 134695760 && ((D = h.read_shift(4)), (we = !0)), (N = h.read_shift(4)), (k = h.read_shift(4))),
                N != g && sn(we, "Bad compressed size: " + g + " != " + N),
                k != d && sn(we, "Bad uncompressed size: " + d + " != " + k),
                d0(m, te, fe, { unsafe: !0, mt: U });
        }
        function Ni(h, g) {
            var d = g || {},
                m = [],
            ...
            for (D = 1; D < h.FullPaths.length; ++D)
                if (((te = h.FullPaths[D].slice(Z.length)), (z = h.FileIndex[D]), !(!z.size || !z.content || te == "Sh33tJ5"))) {
                    ...
                    (Se = Se.slice(0, Se.l)), (Q[X] = Es.buf(z.content, 0));
                    var Ve = z.content;
                    I == 8 && (Ve = F(Ve)),
                        (w = B(30)),
        ...
        function ki(h, g) {
            ...
            var d = h.name || "",
                m = d.match(/\.([^\.]+)$/);
            return (m && Mt[m[1]]) || (g && ((m = (d = g).match(/[\.\\]([^\.\\])+$/)), m && Mt[m[1]])) ? Mt[m[1]] : "application/octet-stream";
        }
        function Pi(h) {
            for (var g = At(h), d = [], m = 0; m < g.length; m += 76) d.push(g.slice(m, m + 76));
            return (
                d.join(`\r
`) +
                `\r
...
`),
                ...
                for (var I = 0; I < w.length; ) {
                    var U = 76,
                        D = w.slice(I, I + U);
                    D.charAt(U - 1) == "=" ? U-- : D.charAt(U - 2) == "=" ? (U -= 2) : D.charAt(U - 3) == "=" && (U -= 3), (D = w.slice(I, I + U)), (I += U), I < w.length && (D += "="), d.push(D);
                }
            }
            return d.join(`\r
`);
        ...
        function Mi(h) {
            for (var g = [], d = 0; d < h.length; ++d) {
                for (var m = h[d]; d <= h.length && m.charAt(m.length - 1) == "="; ) m = m.slice(0, m.length - 1) + h[++d];
                g.push(m);
            }
...
`)
        ...
        function Bi(h, g, d) {
            ...
            var k = d0(h, m.slice(d.length), I, { unsafe: !0 });
            w && (k.ctype = w);
        }
        function Ui(h, g) {
...
`),
            ...
            for (T = 0; T < m.length; ++T)
                if (((w = m[T]), !!/^Content-Location:/i.test(w) && ((w = w.slice(w.indexOf("file"))), d || (d = w.slice(0, w.lastIndexOf("/") + 1)), w.slice(0, d.length) != d)))
                    for (; d.length > 0 && ((d = d.slice(0, d.length - 1)), (d = d.slice(0, d.lastIndexOf("/") + 1)), w.slice(0, d.length) != d); );
            ...
            for (T = 0; T < m.length; ++T) {
                var te = m[T];
                (te !== U && te !== U + "--") || (Z++ && Bi(k, m.slice(X, T), d), (X = T));
            }
            return k;
        }
        function bi(h, g) {
            ...
            m = "------=" + m;
            for (
                var T = ["MIME-Version: 1.0", 'Content-Type: multipart/related; boundary="' + m.slice(2) + '"', "", "", ""], w = h.FullPaths[0], I = w, U = h.FileIndex[0], D = 1;
                ...
                if (((I = h.FullPaths[D].slice(w.length)), (U = h.FileIndex[D]), !(!U.size || !U.content || I == "Sh33tJ5"))) {
                    ...
                    for (var N = U.content, k = ue && Buffer.isBuffer(N) ? N.toString("binary") : Ne(N), X = 0, Z = Math.min(1024, k.length), te = 0, z = 0; z <= Z; ++z)
                        (te = k.charCodeAt(z)) >= 32 && te < 128 && ++X;
                    var Q = X >= (Z * 4) / 5;
                    T.push(m),
                        T.push("Content-Location: " + (d.root || "file:///C:/SheetJS/") + I),
                        T.push("Content-Transfer-Encoding: " + (Q ? "quoted-printable" : "base64")),
                        T.push("Content-Type: " + ki(U, I)),
                        T.push(""),
                        T.push(Q ? Li(k) : Pi(k));
                }
            return (
...
`)
        ...
        function d0(h, g, d, m) {
            ...
            if (!w) {
                var I = h.FullPaths[0];
                g.slice(0, I.length) == I ? (I = g) : (I.slice(-1) != "/" && (I += "/"), (I = (I + g).replace("//", "/"))),
                    (w = { name: a(g), type: 2 }),
                    h.FileIndex.push(w),
                    h.FullPaths.push(I),
                    T || _e.utils.cfb_gc(h);
            }
            return (w.content = d), (w.size = d ? d.length : 0), m && (m.CLSID && (w.clsid = m.CLSID), m.mt && (w.mt = m.mt), m.ct && (w.ct = m.ct)), w;
        }
        function Hi(h, g) {
            C(h);
            var d = _e.find(h, g);
            if (d) {
                for (var m = 0; m < h.FileIndex.length; ++m) if (h.FileIndex[m] == d) return h.FileIndex.splice(m, 1), h.FullPaths.splice(m, 1), !0;
            }
            return !1;
        }
        function Gi(h, g, d) {
            ...
            var m = _e.find(h, g);
            if (m) {
                for (var T = 0; T < h.FileIndex.length; ++T) if (h.FileIndex[T] == m) return (h.FileIndex[T].name = a(d)), (h.FullPaths[T] = d), !0;
            }
            return !1;
        }
        function Vi(h) {
...
function ws(e) {
    return typeof e == "string" ? i0(e) : Array.isArray(e) ? $i(e) : e;
}
function Rt(e, t, r) {
    if (typeof Deno < "u") {
    ...
    if (typeof Blob < "u") {
        var a = new Blob([ws(n)], { type: "application/octet-stream" });
    ...
    if (typeof $ < "u" && typeof File < "u" && typeof Folder < "u")
        try {
            var f = File(e);
            return f.open("w"), (f.encoding = "binary"), Array.isArray(t) && (t = Dt(t)), f.write(t), f.close(), t;
        } catch (o) {
...
function Ss(e) {
    for (var t = [], r = Ge(e), n = 0; n !== r.length; ++n) t[e[r[n]]] == null && (t[e[r[n]]] = []), t[e[r[n]]].push(r[n]);
    return t;
}
var jt = new Date(1899, 11, 30, 0, 0, 0);
function Ze(e, t) {
    var r = e.getTime();
    t && (r -= 1462 * 24 * 60 * 60 * 1e3);
    var n = jt.getTime() + (e.getTimezoneOffset() - jt.getTimezoneOffset()) * 6e4;
    return (r - n) / (24 * 60 * 60 * 1e3);
}
var oa = new Date(),
    As = jt.getTime() + (oa.getTimezoneOffset() - jt.getTimezoneOffset()) * 6e4,
    gn = oa.getTimezoneOffset();
function ca(e) {
    var t = new Date();
    return t.setTime(e * 24 * 60 * 60 * 1e3 + As), t.getTimezoneOffset() !== gn && t.setTime(t.getTime() + (t.getTimezoneOffset() - gn) * 6e4), t;
}
var _n = new Date("2017-02-19T19:06:09.000Z"),
    ha = isNaN(_n.getFullYear()) ? new Date("2/19/17") : _n,
    Fs = ha.getFullYear() == 2017;
function je(e, t) {
    var r = new Date(e);
    if (Fs) return t > 0 ? r.setTime(r.getTime() + r.getTimezoneOffset() * 60 * 1e3) : t < 0 && r.setTime(r.getTime() - r.getTimezoneOffset() * 60 * 1e3), r;
...
function o0(e, t) {
    if (ue && Buffer.isBuffer(e)) {
        if (t) {
            ...
            if (e[1] == 254 && e[2] == 255) return Sr(Yi(e.slice(2).toString("binary")));
        }
    ...
    if (typeof TextDecoder < "u")
        try {
            if (t) {
                if (e[0] == 255 && e[1] == 254) return Sr(new TextDecoder("utf-16le").decode(e.slice(2)));
                if (e[0] == 254 && e[1] == 255) return Sr(new TextDecoder("utf-16be").decode(e.slice(2)));
            }
            var r = {
                "\u20AC": "\x80",
                "\u201A": "\x82",
...
var ys = ["january", "february", "march", "april", "may", "june", "july", "august", "september", "october", "november", "december"];
function Ft(e) {
    var t = new Date(e),
        r = new Date(NaN),
        n = t.getYear(),
    ...
    if (s.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
        if (((s = s.replace(/[^a-z]/g, "").replace(/([^a-z]|^)[ap]m?([^a-z]|$)/, "")), s.length > 3 && ys.indexOf(s) == -1)) return r;
...
function oe(e, t, r) {
    if (e.FullPaths) {
        if (typeof r == "string") {
            var n;
            return ue ? (n = Dr(r)) : (n = ji(r)), _e.utils.cfb_add(e, t, n);
        }
    ...
    for (n = 0; n < e.length; n += a)
        (a = 1),
            (f = e.charCodeAt(n)) < 128
                ...
                : f < 240
                ? ((r = (f & 15) * 4096 + (e.charCodeAt(n + 1) & 63) * 64 + (e.charCodeAt(n + 2) & 63)), (a = 3))
                : ((a = 4),
                  (r = (f & 7) * 262144 + (e.charCodeAt(n + 1) & 63) * 4096 + (e.charCodeAt(n + 2) & 63) * 64 + (e.charCodeAt(n + 3) & 63)),
                  (r -= 65536),
                  (s = 55296 + ((r >>> 10) & 1023)),
                  (r = 56320 + (r & 1023))),
...
var Wt = "foo bar baz\xE2\x98\x83\xF0\x9F\x8D\xA3",
    gt = (ue && ((wn(Wt) == _0(Wt) && wn) || (En(Wt) == _0(Wt) && En))) || _0,
    Sr = ue
        ? function (e) {
...
function Y(e, t, r) {
    return "<" + e + (r != null ? yt(r) : "") + (t != null ? (t.match(xa) ? ' xml:space="preserve"' : "") + ">" + t + "</" + e : "/") + ">";
}
function C0(e, t) {
    try {
...
function Ms(e, t, r) {
    ...
    isFinite(s)
        ? s == 0
            ? (a = i = 0)
            : ((a = Math.floor(Math.log(s) / Math.LN2)), (i = s * Math.pow(2, 52 - a)), a <= -1023 && (!isFinite(i) || i < Math.pow(2, 52)) ? (a = -1022) : ((i -= Math.pow(2, 52)), (a += 1023)))
...
var Sn = function (e) {
    ...
    An = ue
        ...
        : Sn,
    Fn = function (e, t, r) {
        for (var n = [], a = t; a < r; a += 2) n.push(String.fromCharCode(dt(e, a)));
        return n.join("").replace(mt, "");
    },
    M0 = ue
        ? function (e, t, r) {
              return Buffer.isBuffer(e) ? e.toString("utf16le", t, r).replace(mt, "") : Fn(e, t, r);
          }
        : Fn,
    yn = function (e, t, r) {
...
function _t(e, t) {
    ...
    switch (t) {
        case "dbcs":
            ...
            else for (o = 0; o < e; ++o) (r += String.fromCharCode(dt(this, l))), (l += 2);
            e *= 2;
            break;
        case "utf8":
            r = It(this, this.l, this.l + e);
            break;
        case "utf16le":
            (e *= 2), (r = M0(this, this.l, this.l + e));
            break;
        case "wstr":
            return _t.call(this, e, "dbcs");
        case "lpstr-ansi":
            (r = da(this, this.l)), (e = 4 + nr(this, this.l));
            break;
        case "lpstr-cp":
            (r = ga(this, this.l)), (e = 4 + nr(this, this.l));
            break;
        case "lpwstr":
        ...
        case "8lpp4":
            ...
            break;
        case "cstr":
            for (e = 0, r = ""; (s = rt(this, this.l + e++)) !== 0; ) i.push(Bt(s));
            r = i.join("");
            break;
        case "_wstr":
            for (e = 0, r = ""; (s = dt(this, this.l + e)) !== 0; ) i.push(Bt(s)), (e += 2);
            (e += 2), (r = i.join(""));
            break;
        case "dbcs-cont":
            for (r = "", l = this.l, o = 0; o < e; ++o) {
                if (this.lens && this.lens.indexOf(l) !== -1) return (s = rt(this, l)), (this.l = l + 1), (f = _t.call(this, e - o, s ? "dbcs-cont" : "sbcs-cont")), i.join("") + f;
                i.push(Bt(dt(this, l))), (l += 2);
            }
            (r = i.join("")), (e *= 2);
            break;
        case "cpstr":
        ...
        default:
            switch (e) {
                ...
                case 2:
                    return (n = (t === "i" ? Bs : dt)(this, this.l)), (this.l += 2), n;
                case 4:
                case -4:
                    return t === "i" || (this[this.l + 3] & 128) === 0 ? ((n = (e > 0 ? Hr : Us)(this, this.l)), (this.l += 4), n) : ((a = nr(this, this.l)), (this.l += 4), a);
                case 8:
                case -8:
                    if (t === "f")
                        return (
                            e == 8
                                ? (a = Jt(this, this.l))
                                : (a = Jt([this[this.l + 7], this[this.l + 6], this[this.l + 5], this[this.l + 4], this[this.l + 3], this[this.l + 2], this[this.l + 1], this[this.l + 0]], 0)),
                            (this.l += 8),
                            a
                        );
                    e = 8;
...
function Gs(e, t, r) {
    var n = 0,
        a = 0;
    if (r === "dbcs") {
        for (a = 0; a != t.length; ++a) Hs(this, t.charCodeAt(a), this.l + 2 * a);
        n = 2 * t.length;
    } else if (r === "sbcs") {
...
function rr(e, t) {
    (e.l = t), (e.read_shift = _t), (e.chk = ya), (e.write_shift = Gs);
}
function _r(e, t) {
    e.l += t;
}
...
function W(e, t, r, n) {
    var a = +t,
        i;
    if (!isNaN(a)) {
        n || (n = Bh[a].p || (r || []).length || 0), (i = 1 + (a >= 128 ? 1 : 0) + 1), n >= 128 && ++i, n >= 16384 && ++i, n >= 2097152 && ++i;
        var s = e.next(i);
...
function Et(e, t) {
    ...
    var r = me(e);
    return !e.cRel && e.cRel != null && (r = Ks(r)), !e.rRel && e.rRel != null && (r = Vs(r)), r;
}
function T0(e, t) {
    return e.s.r == 0 && !e.s.rRel && e.e.r == (t.biff >= 12 ? 1048575 : t.biff >= 8 ? 65536 : 16384) && !e.e.rRel
        ? (e.s.cRel ? "" : "$") + Xe(e.s.c) + ":" + (e.e.cRel ? "" : "$") + Xe(e.e.c)
        : e.s.c == 0 && !e.s.cRel && e.e.c == (t.biff >= 12 ? 16383 : 255) && !e.e.cRel
        ? (e.s.rRel ? "" : "$") + He(e.s.r) + ":" + (e.e.rRel ? "" : "$") + He(e.e.r)
        : Et(e.s, t.biff) + ":" + Et(e.e, t.biff);
}
function U0(e) {
    return parseInt(Xs(e), 10) - 1;
}
function He(e) {
    return "" + (e + 1);
}
...
function b0(e) {
    for (var t = zs(e), r = 0, n = 0; n !== t.length; ++n) r = 26 * r + t.charCodeAt(n) - 64;
    return r - 1;
}
function Xe(e) {
...
function Or(e, t, r) {
    return e == null || e.t == null || e.t == "z"
        ...
        : e.w !== void 0
        ? e.w
        : (e.t == "d" && !e.z && r && r.dateNF && (e.z = r.dateNF), e.t == "e" ? Nt[e.v] || e.v : t == null ? Dn(e, e.v) : Dn(e, t));
}
function zr(e, t) {
            ...
            for (var x = 0; x != t[p].length; ++x)
                if (!(typeof t[p][x] > "u")) {
                    ...
                    if (
                        ...
                        l.e.r < E && (l.e.r = E),
                        l.e.c < u && (l.e.c = u),
                        t[p][x] && typeof t[p][x] == "object" && !Array.isArray(t[p][x]) && !(t[p][x] instanceof Date))
                    )
                        v = t[p][x];
                    else if ((Array.isArray(v.v) && ((v.f = t[p][x][1]), (v.v = v.v[0])), v.v === null))
                        if (v.f) v.t = "n";
                        ...
                        typeof v.v == "number"
                            ...
                            ? (v.t = "b")
                            : v.v instanceof Date
                            ? ((v.z = n.dateNF || ye[14]), n.cellDates ? ((v.t = "d"), (v.w = kr(v.z, Ze(v.v)))) : ((v.t = "n"), (v.v = Ze(v.v)), (v.w = kr(v.z, v.v))))
                            : (v.t = "s");
                    if (a) i[E] || (i[E] = []), i[E][u] && i[E][u].z && (v.z = i[E][u].z), (i[E][u] = v);
                    else {
                        var _ = me({ c: u, r: E });
...
function W0(e, t) {
    var r = e.l,
        ...
        s = { t: a, h: a };
    if ((n & 1) !== 0) {
        for (var f = e.read_shift(4), o = 0; o != f; ++o) i.push(js(e));
        s.r = i;
...
function Qs(e, t) {
    var r = !1;
    return t == null && ((r = !0), (t = B(23 + 4 * e.t.length))), t.write_shift(1, 1), Le(e.t, t), t.write_shift(4, 1), Js({ ich: 0, ifnt: 0 }, t), r ? t.slice(0, t.l) : t;
}
function or(e) {
    var t = e.read_shift(4),
        r = e.read_shift(2);
...
function Da(e) {
    var t = e.slice(e.l, e.l + 4),
        ...
        n = t[0] & 2;
    e.l += 4;
    var a = n === 0 ? Jt([0, 0, 0, 0, t[0] & 252, t[1], t[2], t[3]], 0) : Hr(t, 0) >> 2;
    return r ? a / 100 : a;
}
function Ra(e, t) {
    t == null && (t = B(4));
...
var Na = 2,
    ...
    Rn = {
        ...
        11: { n: "ScaleCrop", t: Ht },
        12: { n: "HeadingPairs", t: of },
        13: { n: "TitlesOfParts", t: cf },
        14: { n: "Manager", t: Ue },
        15: { n: "Company", t: Ue },
        16: { n: "LinksUpToDate", t: Ht },
        17: { n: "CharacterCount", t: er },
        19: { n: "SharedDoc", t: Ht },
        22: { n: "HyperlinksChanged", t: Ht },
...
var uf = hf([
        0, 16777215, 16711680, 65280, 255, 16776960, 16711935, 65535, 0, 16777215, 16711680, 65280, 255, 16776960, 16711935, 65535, 8388608, 32768, 128, 8421376, 8388736, 32896, 12632256, 8421504,
        10066431, 10040166, 16777164, 13434879, 6684774, 16744576, 26316, 13421823, 128, 16711935, 16776960, 65535, 8388736, 8388608, 32896, 255, 52479, 13434879, 13434828, 16777113, 10079487,
        16751052, 13408767, 16764057, 3368703, 3394764, 10079232, 16763904, 16750848, 16737792, 6710937, 9868950, 13158, 3381606, 13056, 3355392, 10040064, 10040166, 3355545, 3355443, 16777215, 0, 0,
    ...
    var i = function (o) {
            e[o] &&
                ...
                (n[n.length] = Y("Override", null, {
                    PartName: (a[0] == "/" ? "" : "/") + a,
                    ContentType: Vt[o][t.bookType] || Vt[o].xlsx,
                })));
        },
        s = function (o) {
...
function pe(e, t, r, n, a, i) {
    ...
    if (
        ...
        (a.Type = n),
        (a.Target = r),
        i ? (a.TargetMode = i) : [he.HLINK, he.XPATH, he.XMISS].indexOf(a.Type) > -1 && (a.TargetMode = "External"),
        e["!id"][a.Id])
    )
...
`);
    for (var r = 0; r != e.length; ++r) t.push(Nn(e[r][0], e[r][1])), t.push(df("", e[r][0]));
...
function E0(e, t, r, n, a) {
    a[e] != null || t == null || t === "" || ((a[e] = t), (t = de(t)), (n[n.length] = r ? Y(e, t, r) : We(e, t)));
}
function Ba(e, t) {
    var r = t || {},
        n = [
    ...
    e &&
        (e.CreatedDate != null && E0("dcterms:created", typeof e.CreatedDate == "string" ? e.CreatedDate : C0(e.CreatedDate, r.WTF), { "xsi:type": "dcterms:W3CDTF" }, n, a),
        e.ModifiedDate != null && E0("dcterms:modified", typeof e.ModifiedDate == "string" ? e.ModifiedDate : C0(e.ModifiedDate, r.WTF), { "xsi:type": "dcterms:W3CDTF" }, n, a));
...
var it = [
    ...
    Ua = ["Worksheets", "SheetNames", "NamedRanges", "DefinedNames", "Chartsheets", "ChartNames"];
function ba(e) {
    var t = [],
        r = Y;
    return (
        ...
        (t[t.length] = r("HeadingPairs", r("vt:vector", r("vt:variant", "<vt:lpstr>Worksheets</vt:lpstr>") + r("vt:variant", r("vt:i4", String(e.Worksheets))), { size: 2, baseType: "variant" }))),
        (t[t.length] = r(
            "TitlesOfParts",
            r(
                "vt:vector",
...
function Wa(e) {
    var t = [Re, Y("Properties", null, { xmlns: ke.CUST_PROPS, "xmlns:vt": ke.vt })];
    if (!e) return t.join("");
    var r = 1;
    return (
        Ge(e).forEach(function (a) {
            ++r,
                (t[t.length] = Y("property", Ps(e[a], !0), {
...
function Ln(e, t, r) {
    ...
    if ((o.write_shift(4, 2), o.write_shift(4, 1200), l.write_shift(4, 1), i.push(o), a.push(l), (s += 8 + o.length), !t)) {
        ...
        for (c[0].write_shift(4, e.length), f = 0; f < e.length; ++f) {
            var p = e[f][0];
            for (o = B(4 + 4 + 2 * (p.length + 1) + (p.length % 2 ? 0 : 2)), o.write_shift(4, f + 2), o.write_shift(4, p.length + 1), o.write_shift(0, p, "dbcs"); o.l != o.length; )
                o.write_shift(1, 0);
            c.push(o);
        }
...
function yf(e, t, r) {
    ...
    return n === 0 ? (e.l++, "") : Ff(e, n, r);
}
function Cf(e, t, r) {
    if (r.biff > 5) return yf(e, t, r);
...
function V0(e, t, r) {
    ...
    return (
        ...
        a > 8 && (i.write_shift(2, 49161), i.write_shift(2, 1), i.write_shift(2, 1798), i.write_shift(2, 0)),
        i
    );
}
function If(e, t) {
...
function kf(e, t) {
    ...
    for (var n = [], a = 0; a < e.length; ++a) n[a] = Af(e[a]);
    var i = be([r].concat(n));
    return (
...
function Uf(e, t, r, n, a) {
    ...
    return Kr(e, t, n, s), s.write_shift(2, r.length), i && s.write_shift(1, 1), s.write_shift((1 + i) * r.length, r, i ? "utf16le" : "sbcs"), s;
}
function bf(e, t, r, n) {
    var a = r && r.biff == 5;
...
function Xf(e, t, r) {
    ...
    for (var n = [], a = e.l + t, i = e.read_shift(r.biff > 8 ? 4 : 2); i-- !== 0; ) n.push(Df(e, r.biff > 8 ? 12 : 6, r));
...
function Qf(e, t, r) {
    var n = B(15);
    return Pt(n, e, t), n.write_shift(8, r, "f"), n;
}
function el(e, t, r) {
    var n = B(9);
    return Pt(n, e, t), n.write_shift(2, r), n;
}
var rl = (function () {
        var e = {
                1: 437,
        ...
        function r(f, o) {
            ...
            for (var y = [], M = {}, j = Math.min(c.length, p == 2 ? 521 : _ - 10 - (v ? 264 : 0)), ee = E ? 32 : 11; c.l < j && c[c.l] != 13; )
                switch (
                    ((M = {}),
                    (M.name = Wr.utils.decode(R, c.slice(c.l, c.l + ee)).replace(/[\u0000\r\n].*$/g, "")),
                    (c.l += ee),
                    (M.type = String.fromCharCode(c.read_shift(1))),
                    p != 2 && !E && (M.offset = c.read_shift(4)),
                    (M.len = c.read_shift(1)),
                    p == 2 && (M.offset = c.read_shift(2)),
        ...
        function s(f, o) {
            var l = o || {};
            if ((+l.codepage >= 0 && St(+l.codepage), l.type == "string")) throw new Error("Cannot write DBF to JS string");
            var c = Je(),
                p = a0(f, { header: 1, raw: !0, cellDates: !0 }),
                x = p[0],
                v = p.slice(1),
                E = f["!cols"] || [],
                u = 0,
            ...
            for (u = 0; u <= y.e.c - y.s.c; ++u) {
                var C = "",
                    ...
                    L = 0,
                    G = [];
                for (_ = 0; _ < v.length; ++_) v[_][u] != null && G.push(v[_][u]);
            ...
            for (V.write_shift(4, 0 | ((+t[$n] || 3) << 8)), u = 0, _ = 0; u < x.length; ++u)
                if (x[u] != null) {
                    var K = c.next(32),
                ...
                for (le.write_shift(1, 0), _ = 0; _ < x.length; ++_)
                    if (x[_] != null)
                        switch (M[_]) {
                            ...
                            case "D":
                                v[u][_]
                                    ? (le.write_shift(4, ("0000" + v[u][_].getFullYear()).slice(-4), "sbcs"),
                                      le.write_shift(2, ("00" + (v[u][_].getMonth() + 1)).slice(-2), "sbcs"),
                                      le.write_shift(2, ("00" + v[u][_].getDate()).slice(-2), "sbcs"))
    ...
    tl = (function () {
        ...
        function a(x, v) {
            switch (v.type) {
                ...
                case "binary":
                    return i(x, v);
                case "buffer":
                    return i(ue && Buffer.isBuffer(x) ? x.toString("binary") : Dt(x), v);
                case "array":
                    return i(o0(x), v);
            }
        ...
        function i(x, v) {
            var E = x.split(/[\n\r]+/),
                ...
                G = 0,
                V;
            for (+v.codepage >= 0 && St(+v.codepage); O !== E.length; ++O) {
                G = 0;
                var K = E[O].trim()
                                    ...
                                    case "K":
                                        (le = re[R].slice(1)),
                                            le.charAt(0) === '"'
                                                ...
                                                ? (le = !1)
                                                : isNaN(Fr(le))
                                                ? isNaN(Ft(le).getDate()) || (le = je(le))
                                                : ((le = Fr(le)), j !== null && sa(j) && (le = ca(le))),
                                            (Me = !0);
                                        break;
                                    case "E":
                                        Ne = !0;
        ...
        function l(x, v) {
            v.forEach(function (E, u) {
                ...
                E.hidden
                    ? (_ += "0")
                    : (typeof E.width == "number" && !E.wpx && (E.wpx = e0(E.width)), typeof E.wpx == "number" && !E.wch && (E.wch = r0(E.wpx)), typeof E.wch == "number" && (_ += Math.round(E.wch))),
...
`;
            E.push("P;PGeneral"),
                ...
                x["!cols"] && l(E, x["!cols"]),
                x["!rows"] && c(E, x["!rows"]),
                E.push("B;Y" + (_.e.r - _.s.r + 1) + ";X" + (_.e.c - _.s.c + 1) + ";D" + [_.s.c, _.s.r, _.e.c, _.e.r].join(" "));
        ...
        function e(i, s) {
            switch (s.type) {
                ...
                case "binary":
                    return t(i, s);
                case "buffer":
                    return t(ue && Buffer.isBuffer(i) ? i.toString("binary") : Dt(i), s);
                case "array":
                    return t(o0(i), s);
            }
...
` + f[++c];
                    switch (((u = u.trim()), +v)) {
                        case -1:
                            ...
                            break;
                        case 0:
                            u === "TRUE" ? (p[o][l] = !0) : u === "FALSE" ? (p[o][l] = !1) : isNaN(Fr(E)) ? (isNaN(Ft(E).getDate()) ? (p[o][l] = E) : (p[o][l] = je(E))) : (p[o][l] = Fr(E)), ++l;
                            break;
                        case 1:
                            (u = u.slice(1, u.length - 1)), (u = u.replace(/""/g, '"')), u && u.match(/^=".*"$/) && (u = u.slice(2, -1)), (p[o][l++] = u !== "" ? u : null);
                            break;
                    }
                    if (u === "EOD") break;
                }
                ...
                for (var v = c.s.r; v <= c.e.r; ++v) {
                    ...
                    for (var E = c.s.c; E <= c.e.c; ++E) {
                        ...
                        switch (p.t) {
                            case "n":
                                var _ = p.w;
                                !_ && p.v != null && (_ = p.v), _ == null ? (p.f && !p.F ? s(l, 1, 0, "=" + p.f) : s(l, 1, 0, "")) : s(l, 0, _, "V");
                                break;
                            case "b":
                            ...
                            case "s":
                                ...
                                break;
                            case "d":
                                p.w || (p.w = kr(p.z || ye[14], Ze(je(p.v)))), s(l, 0, p.w, "V");
                                break;
                            default:
                                s(l, 1, 0, "");
                        }
...
`),
        ...
        function l(p) {
            if (!p || !p["!ref"]) return "";
            for (var x = [], v = [], E, u = "", _ = ar(p["!ref"]), O = Array.isArray(p), R = _.s.r; R <= _.e.r; ++R)
                for (var y = _.s.c; y <= _.e.c; ++y)
                    if (((u = me({ r: R, c: y })), (E = O ? (p[R] || [])[y] : p[u]), !(!E || E.v == null || E.t === "z"))) {
                        switch (((v = ["cell", u, "t"]), E.t)) {
                            ...
                            case "d":
                                var M = Ze(je(E.v));
                                (v[2] = "vtc"), (v[3] = "nd"), (v[4] = "" + M), (v[5] = E.w || kr(E.z || ye[14], M));
                                break;
                            case "e":
                                continue;
                        }
...
`);
    ...
    al = (function () {
        function e(c, p, x, v, E) {
            E.raw
                ? (p[x][v] = c)
                : c === "" || (c === "TRUE" ? (p[x][v] = !0) : c === "FALSE" ? (p[x][v] = !1) : isNaN(Fr(c)) ? (isNaN(Ft(c).getDate()) ? (p[x][v] = c) : (p[x][v] = je(c))) : (p[x][v] = Fr(c)));
        }
        function t(c, p) {
            var x = p || {},
                v = [];
            ...
            for (var _ = 10, O = 0, R = 0; R <= u; ++R) (O = E[R].indexOf(" ")), O == -1 ? (O = E[R].length) : O++, (_ = Math.max(_, O));
            for (R = 0; R <= u; ++R) {
                v[R] = [];
                var y = 0;
                for (e(E[R].slice(0, _).trim(), v, R, y, x), y = 1; y <= (E[R].length - _) / 10 + 1; ++y) e(E[R].slice(_ + (y - 1) * 10, _ + y * 10).trim(), v, R, y, x);
            }
        ...
        function a(c) {
            for (var p = {}, x = !1, v = 0, E = 0; v < c.length; ++v) (E = c.charCodeAt(v)) == 34 ? (x = !x) : !x && E in r && (p[E] = (p[E] || 0) + 1);
            E = [];
            for (v in p) Object.prototype.hasOwnProperty.call(p, v) && E.push([p[v], v]);
            if (!E.length) {
                p = n;
                for (v in p) Object.prototype.hasOwnProperty.call(p, v) && E.push([p[v], v]);
            }
        ...
        function i(c, p) {
            ...
            c.slice(0, 4) == "sep="
                ? c.charCodeAt(5) == 13 && c.charCodeAt(6) == 10
                    ? ((v = c.charAt(4)), (c = c.slice(7)))
                    : c.charCodeAt(5) == 13 || c.charCodeAt(5) == 10
                    ? ((v = c.charAt(4)), (c = c.slice(6)))
                    : (v = a(c.slice(0, 1024)))
                : x && x.FS
                ? (v = x.FS)
                : (v = a(c.slice(0, 1024)));
...
`
            ...
            var L = x.dateNF != null ? _s(x.dateNF) : null;
            function G() {
                var V = c.slice(y, M),
                    K = {};
                ...
                else if (!isNaN((R = Fr(V)))) (K.t = "n"), x.cellText !== !1 && (K.w = V), (K.v = R);
                else if (!isNaN(Ft(V).getDate()) || (L && V.match(L))) {
                    K.z = x.dateNF || ye[14];
                    var re = 0;
                    L && V.match(L) && ((V = Ts(V, x.dateNF, V.match(L) || [])), (re = 1)),
                        x.cellDates ? ((K.t = "d"), (K.v = je(V, re))) : ((K.t = "n"), (K.v = Ze(je(V, re)))),
                        x.cellText !== !1 && (K.w = kr(K.z, K.v instanceof Date ? Ze(K.v) : K.v)),
                        x.cellNF || delete K.z;
                } else (K.t = "s"), (K.v = V);
                if (
                    (K.t == "z" || (x.dense ? (E[_] || (E[_] = []), (E[_][O] = K)) : (E[me({ c: O, r: _ })] = K)),
                    (y = M + 1),
                    (b = c.charCodeAt(y)),
                    u.e.c < O && (u.e.c = O),
                    u.e.r < _ && (u.e.r = _),
        ...
        function s(c, p) {
            return !(p && p.PRN) || p.FS || c.slice(0, 4) == "sep=" || c.indexOf("	") >= 0 || c.indexOf(",") >= 0 || c.indexOf(";") >= 0 ? i(c, p) : ot(t(c, p), p);
        }
        function f(c, p) {
            var x = "",
                v = p.type == "string" ? [0, 0, 0, 0] : mu(c, p);
            switch (p.type) {
                case "base64":
                    x = Cr(c);
                    break;
                ...
                case "buffer":
                    p.codepage == 65001
                        ? (x = c.toString("utf8"))
                        : p.codepage && typeof Wr < "u"
                        ? (x = Wr.utils.decode(p.codepage, c))
                        : (x = ue && Buffer.isBuffer(c) ? c.toString("binary") : Dt(c));
                    break;
                case "array":
                    x = o0(c);
                    break;
            ...
            return (
                v[0] == 239 && v[1] == 187 && v[2] == 191
                    ...
                    ? (x = gt(x))
                    : p.type == "binary" && typeof Wr < "u" && p.codepage && (x = Wr.utils.decode(p.codepage, Wr.utils.encode(28591, x))),
                x.slice(0, 19) == "socialcalc:version:" ? Ya.to_sheet(p.type == "string" ? x : gt(x), p) : s(x, p)
            );
        }
        function o(c, p) {
            return zr(f(c, p), p);
        ...
        function l(c) {
            for (var p = [], x = Ee(c["!ref"]), v, E = Array.isArray(c), u = x.s.r; u <= x.e.r; ++u) {
                for (var _ = [], O = x.s.c; O <= x.e.c; ++O) {
                    ...
                    for (var y = (v.w || (Or(v), v.w) || "").slice(0, 10); y.length < 10; ) y += " ";
                    _.push(y + (O === 0 ? " " : ""));
                }
                p.push(_.join(""));
            }
    ...
    bn = (function () {
        ...
        function r(S, P) {
                            ...
                            switch (Er) {
                                ...
                                case 16:
                                    Er == 14 &&
                                        ...
                                        (ne[2] & 15) > 1 &&
                                        (ne[2] & 15) < 15 &&
                                        ((ne[1].z = F.dateNF || ye[14]), F.cellDates && ((ne[1].t = "d"), (ne[1].v = ca(ne[1].v)))),
                                        F.qpro &&
                                            ne[3] > se &&
                                            ((A["!ref"] = De(ce)),
                                            (ae[H] = A),
                                    ...
                                    if (Br) {
                                        (Br.t = ne[1].t), (Br.v = ne[1].v), ne[1].z != null && (Br.z = ne[1].z), ne[1].f != null && (Br.f = ne[1].f);
                                        break;
                                    }
                                    F.dense ? (A[ne[0].r] || (A[ne[0].r] = []), (A[ne[0].r][ne[0].c] = ne[1])) : (A[me(ne[0])] = ne[1]);
                                    break;
                            }
                        },
                        F
            ...
            for (var xe = {}, Tr = [], Ae = 0; Ae < Te.length; ++Ae)
                ae[q[Ae]] ? (Tr.push(Te[Ae] || q[Ae]), (xe[Te[Ae]] = ae[Te[Ae]] || ae[q[Ae]])) : (Tr.push(Te[Ae]), (xe[Te[Ae]] = { "!ref": "A1" }));
            return { SheetNames: Tr, Sheets: xe };
        }
        function n(S, P) {
            var F = P || {};
            if ((+F.codepage >= 0 && St(+F.codepage), F.type == "string")) throw new Error("Cannot write WK1 to JS string");
            var A = Je(),
                H = Ee(S["!ref"]),
                ie = Array.isArray(S),
                se = [];
            ...
            for (var ae = Math.min(H.e.r, 8191), q = H.s.r; q <= ae; ++q)
                for (var Te = He(q), ce = H.s.c; ce <= H.e.c; ++ce) {
                    ...
                    var ze = se[ce] + Te,
                        xe = ie ? (S[q] || [])[ce] : S[ze];
                    if (!(!xe || xe.t == "z"))
                        if (xe.t == "n") (xe.v | 0) == xe.v && xe.v >= -32768 && xe.v <= 32767 ? J(A, 13, v(q, ce, xe.v)) : J(A, 14, u(q, ce, xe.v));
                        else {
                            var Tr = Or(xe);
                            J(A, 15, p(q, ce, Tr.slice(0, 239)));
                        }
                }
            return J(A, 1), A.end();
        }
        function a(S, P) {
            var F = P || {};
            if ((+F.codepage >= 0 && St(+F.codepage), F.type == "string")) throw new Error("Cannot write WK3 to JS string");
            var A = Je();
            J(A, 0, s(S));
        ...
        function f(S, P, F) {
            ...
            return P == 8 && F.qpro
                ? ((A.s.c = S.read_shift(1)), S.l++, (A.s.r = S.read_shift(2)), (A.e.c = S.read_shift(1)), S.l++, (A.e.r = S.read_shift(2)), A)
        ...
        function l(S, P, F) {
            ...
            return (
                F.qpro && F.vers != 20768
                    ? ((A[0].c = S.read_shift(1)), (A[3] = S.read_shift(1)), (A[0].r = S.read_shift(2)), (S.l += 2))
        ...
        function L(S, P) {
            var F = j(S),
                ...
                H = S.read_shift(4),
                ie = S.read_shift(2);
            if (ie == 65535) return A === 0 && H === 3221225472 ? ((F[1].t = "e"), (F[1].v = 15)) : A === 0 && H === 3489660928 ? ((F[1].t = "e"), (F[1].v = 42)) : (F[1].v = 0), F;
            var se = ie & 32768;
            return (ie = (ie & 32767) - 16446), (F[1].v = (1 - se * 2) * (H * Math.pow(2, ie + 32) + A * Math.pow(2, ie))), F;
        }
        function G(S, P, F, A) {
            var H = B(14);
            if ((H.write_shift(2, S), H.write_shift(1, F), H.write_shift(1, P), A == 0)) return H.write_shift(4, 0), H.write_shift(4, 0), H.write_shift(2, 65535), H;
            var ie = 0,
                se = 0,
                ae = 0,
                q = 0;
        ...
        function cr(S, P) {
            for (var F = {}, A = S.l + P; S.l < A; ) {
                var H = S.read_shift(2);
                if (H == 14e3) {
                    for (F[H] = [0, ""], F[H][0] = S.read_shift(2); S[S.l]; ) (F[H][1] += String.fromCharCode(S[S.l])), S.l++;
                    S.l++;
                }
            }
            return F;
...
function $a(e, t) {
    ...
    for (var n = 0; n != e.length; ++n)
        if (e[n] != null) {
            var a = e[n],
                i = "<si>";
            a.r ? (i += a.r) : ((i += "<t"), a.t || (a.t = ""), a.t.match(il) && (i += ' xml:space="preserve"'), (i += ">" + de(a.t) + "</t>")), (i += "</si>"), (r[r.length] = i);
        }
...
function ol(e) {
    var t = Je();
    W(t, 159, fl(e));
    for (var r = 0; r < e.length; ++r) W(t, 19, ll(e[r]));
...
function ja(e) {
    ...
    for (i = a - 1; i >= 0; --i) (s = r[i]), (f = (t & 16384) === 0 ? 0 : 1), (o = (t << 1) & 32767), (l = f | o), (t = l ^ s);
    return t ^ 52811;
}
var hl = (function () {
    function e(a, i) {
        switch (i.type) {
            ...
            case "binary":
                return t(a, i);
            case "buffer":
                return t(ue && Buffer.isBuffer(a) ? a.toString("binary") : Dt(a), i);
            case "array":
                return t(o0(a), i);
        }
                    ...
                    switch (E[0]) {
                        case "\\cell":
                            ...
                            if ((_[0] == " " && (_ = _.slice(1)), ++u, _.length)) {
                                var O = { v: _, t: "s" };
                                Array.isArray(f) ? (f[p][u] = O) : (f[me({ r: p, c: u })] = O);
                            }
                            break;
                    }
                    v = x.lastIndex;
    ...
    function n(a) {
        for (var i = ["{\\rtf1\\ansi"], s = Ee(a["!ref"]), f, o = Array.isArray(a), l = s.s.r; l <= s.e.r; ++l) {
            ...
            for (i.push("\\pard\\intbl"), c = s.s.c; c <= s.e.c; ++c) {
                var p = me({ r: l, c });
                (f = o ? (a[l] || [])[c] : a[p]), !(!f || (f.v == null && (!f.f || f.F))) && (i.push(" " + (f.w || (Or(f), f.w))), i.push("\\cell"));
            }
...
function X0(e) {
    e.width
        ? ((e.wpx = e0(e.width)), (e.wch = r0(e.wpx)), (e.MDW = yr))
        : e.wpx
        ? ((e.wch = r0(e.wpx)), (e.width = D0(e.wch)), (e.MDW = yr))
        : typeof e.wch == "number" && ((e.width = D0(e.wch)), (e.wpx = e0(e.width)), (e.MDW = yr)),
...
function pl(e) {
    ...
    return (
        ...
        (t[t.length] = "</cellXfs>"),
        t.length === 2 ? "" : ((t[0] = Y("cellXfs", null, { count: t.length - 2 }).replace("/>", ">")), t.join(""))
    );
}
function qa(e, t) {
    var r = [Re, Y("styleSheet", null, { xmlns: lt[0], "xmlns:vt": ke.vt })],
        n;
    return (
        e.SSF && (n = vl(e.SSF)) != null && (r[r.length] = n),
...
function _l(e, t) {
    t || (t = B(25 + 4 * 32)), t.write_shift(2, e.sz * 20), sf(e, t), t.write_shift(2, e.bold ? 700 : 400);
    var r = 0;
...
var Tl = [
    ...
    El = _r;
function Hn(e, t) {
    t || (t = B(4 * 3 + 8 * 7 + 16 * 1)), w0 || (w0 = N0(Tl));
    var r = w0[e.patternType];
    r == null && (r = 40), t.write_shift(4, r);
    var n = 0;
    if (r != 40) for (qt({ auto: 1 }, t), qt({ auto: 1 }, t); n < 12; ++n) t.write_shift(4, 0);
    else {
...
var Sl = _r;
function Al(e, t) {
    return t || (t = B(51)), t.write_shift(1, 0), pt(null, t), pt(null, t), pt(null, t), pt(null, t), pt(null, t), t.length > t.l ? t.slice(0, t.l) : t;
}
function Fl(e, t) {
    return t || (t = B(12 + 4 * 10)), t.write_shift(4, e.xfId), t.write_shift(2, 1), t.write_shift(1, +e.builtinId), t.write_shift(1, 0), Zt(e.name || "", t), t.length > t.l ? t.slice(0, t.l) : t;
}
function yl(e, t, r) {
    var n = B(2052);
        ...
        [
            ...
            r != 0 &&
                ...
                [
                    ...
                    for (var a = n[0]; a <= n[1]; ++a) t[a] != null && W(e, 44, ml(a, t[a]));
                }),
                W(e, 616));
    }
}
...
function Dl(e) {
    var t = 2;
    W(e, 603, pr(t)), W(e, 45, Hn({ patternType: "none" })), W(e, 45, Hn({ patternType: "gray125" })), W(e, 604);
}
function Rl(e) {
    var t = 1;
    W(e, 613, pr(t)), W(e, 46, Al()), W(e, 614);
}
function Il(e) {
    var t = 1;
    W(e, 626, pr(t)), W(e, 47, Qa({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535)), W(e, 627);
}
function Nl(e, t) {
    W(e, 617, pr(t.length)),
...
function kl(e) {
    var t = 1;
    W(e, 619, pr(t)), W(e, 48, Fl({ xfId: 0, builtinId: 0, name: "Normal" })), W(e, 620);
}
function Pl(e) {
    var t = 0;
...
function Ll(e) {
    var t = 0;
    W(e, 508, yl(t, "TableStyleMedium9", "PivotStyleMedium4")), W(e, 509);
}
function Ml(e, t) {
    var r = Je();
    return W(r, 278), Cl(r, e.SSF), Ol(r), Dl(r), Rl(r), Il(r), Nl(r, t.cellXfs), kl(r), Pl(r), Ll(r), W(r, 279), r.end();
}
function ei(e, t) {
...
function Xl() {
    ...
    return (
        W(e, 332),
        W(e, 334, pr(1)),
        W(e, 335, Ul({ name: "XLDAPR", version: 12e4, flags: 3496657072 })),
        W(e, 336),
        W(e, 339, Hl(1, "XLDAPR")),
        W(e, 52),
        W(e, 35, pr(514)),
...
function ti(e, t) {
    ...
    return (
        t.forEach(function (i) {
            ...
            var o = f.type == "gradient" ? Y("o:fill", null, { type: "gradientUnscaled", "v:ext": "view" }) : null,
                l = Y("v:fill", o, f),
                c = { on: "t", obscured: "t" };
            ++tt,
                (a = a.concat([
        ...
        e.forEach(function (n) {
            n[1].forEach(function (a) {
                ...
                r.indexOf(i) == -1 && (r.push(i), t.push("<author>" + i + "</author>")),
                    a.T && a.ID && r.indexOf("tc=" + a.ID) == -1 && (r.push("tc=" + a.ID), t.push("<author>tc=" + a.ID + "</author>"));
            });
        }),
        ...
        e.forEach(function (a) {
            ...
            (a[1] || []).forEach(function (s, f) {
                ...
                f == 0 ? (i = o.id) : (o.parentId = i),
                    (s.ID = o.id),
                    s.a && (o.personId = "{54EE7950-7262-4200-6969-" + ("000000000000" + t.indexOf(s.a)).slice(-12) + "}"),
...
function Yl(e) {
    var t = [Re, Y("personList", null, { xmlns: ke.TCMNT, "xmlns:x": lt[0] }).replace(/[\/]>/, ">")];
    return (
...
function jl(e, t) {
    return t == null && (t = B(36)), t.write_shift(4, e[1].iauthor), ct(e[0], t), t.write_shift(4, 0), t.write_shift(4, 0), t.write_shift(4, 0), t.write_shift(4, 0), t;
}
var Jl = Ke;
function Zl(e) {
...
function ql(e) {
    ...
    return (
        ...
        e.forEach(function (n) {
            n[1].forEach(function (a) {
                r.indexOf(a.a) > -1 || (r.push(a.a.slice(0, 54)), W(t, 632, Zl(a.a)));
            });
        }),
        W(t, 631),
        W(t, 633),
        e.forEach(function (n) {
            n[1].forEach(function (a) {
                ...
                W(t, 635, jl([i, a])), a.t && a.t.length > 0 && W(t, 637, Qs(a)), W(t, 636), delete a.iauthor;
            });
        }),
        W(t, 634),
        W(t, 629),
...
var ai = ["xlsb", "xlsm", "xlam", "biff8", "xla"],
    eo = (function () {
    ...
    K0 = /(^|[^._A-Z0-9])([$]?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])([$]?)(10[0-3]\d{4}|104[0-7]\d{3}|1048[0-4]\d{2}|10485[0-6]\d|104857[0-6]|[1-9]\d{0,5})(?![_.\(A-Za-z0-9])/g,
    z0 = (function () {
        return function (t, r) {
...
function fi(e, t, r) {
    if (r && r.biff >= 2 && r.biff <= 5) return ao(e);
...
function lo(e, t, r) {
    var n = (e[e.l++] & 96) >> 5,
        a = ii(e, r.biff >= 2 && r.biff <= 5 ? 6 : 8, r);
    return [n, a];
}
function oo(e, t, r) {
    var n = (e[e.l++] & 96) >> 5,
...
function yo(e, t, r) {
    var n = e[e.l++],
        a = e.read_shift(1),
        i = r && r.biff <= 3 ? [n == 88 ? -1 : 0, e.read_shift(1)] : Co(e);
    return [a, (i[0] === 0 ? hi : Ac)[i[1]]];
}
function Co(e) {
...
function Lo(e, t) {
    ...
    switch (r[0]) {
        case 4:
            (r[1] = Sf(e, 1) ? "TRUE" : "FALSE"), t != 12 && (e.l += 7);
            break;
        case 37:
        case 16:
...
function Mo(e, t, r) {
    for (var n = e.read_shift(r.biff == 12 ? 4 : 2), a = [], i = 0; i != n; ++i) a.push((r.biff == 12 ? Jr : Rf)(e));
    return a;
}
function Bo(e, t, r) {
    var n = 0,
    ...
    for (var i = 0, s = []; i != n && (s[i] = []); ++i) for (var f = 0; f != a; ++f) s[i][f] = Lo(e, r.biff);
    return s;
}
function Uo(e, t, r) {
...
var qo = kt,
    ...
    rc = kt,
    tc = kt,
    nc = ["Data", "All", "Headers", "??", "?Data2", "??", "?DataHeaders", "??", "Totals", "??", "??", "??", "?DataTotals", "??", "??", "??", "?Current"];
function ac(e) {
    e.l += 2;
    var t = e.read_shift(2),
        r = e.read_shift(2),
...
var Vn = {
        ...
        32: { n: "PtgArray", f: xo },
        33: { n: "PtgFunc", f: Fo },
        34: { n: "PtgFuncVar", f: yo },
        35: { n: "PtgName", f: Uo },
        36: { n: "PtgRef", f: wo },
        37: { n: "PtgArea", f: lo },
        38: { n: "PtgMemArea", f: Ho },
        39: { n: "PtgMemErr", f: Ko },
        40: { n: "PtgMemNoMem", f: zo },
        41: { n: "PtgMemFunc", f: Go },
        42: { n: "PtgRefErr", f: Vo },
        43: { n: "PtgAreaErr", f: co },
        44: { n: "PtgRefN", f: So },
        45: { n: "PtgAreaN", f: uo },
        46: { n: "PtgMemAreaN", f: lc },
        47: { n: "PtgMemNoMemN", f: oc },
        57: { n: "PtgNameX", f: bo },
        58: { n: "PtgRef3d", f: Ao },
        59: { n: "PtgArea3d", f: oo },
        60: { n: "PtgRefErr3d", f: Xo },
    ...
    uc = {
        ...
        6: { n: "PtgElfRwV", f: tc },
        7: { n: "PtgElfColV", f: Zo },
        10: { n: "PtgElfRadical", f: qo },
        11: { n: "PtgElfRadicalS", f: ec },
        13: { n: "PtgElfColS", f: jo },
    ...
    xc = {
        0: { n: "PtgAttrNoop", f: cc },
        1: { n: "PtgAttrSemi", f: _o },
        2: { n: "PtgAttrIf", f: mo },
        4: { n: "PtgAttrChoose", f: vo },
        8: { n: "PtgAttrGoto", f: po },
        16: { n: "PtgAttrSum", f: Oo },
        32: { n: "PtgAttrBaxcel", f: Gn },
        33: { n: "PtgAttrBaxcel", f: Gn },
        64: { n: "PtgAttrSpace", f: To },
        65: { n: "PtgAttrSpaceSemi", f: Eo },
...
function vc(e, t, r, n) {
    ...
    for (var a = e.l + t, i = [], s = 0; s !== r.length; ++s)
        switch (r[s][0]) {
            case "PtgArray":
                (r[s][1] = Bo(e, 0, n)), i.push(r[s][1]);
                break;
            case "PtgMemArea":
                (r[s][2] = Mo(e, r[s][1], n)), i.push(r[s][2]);
                break;
            case "PtgExp":
...
function pc(e, t, r) {
    for (var n = e.l + t, a, i, s = []; n != e.l; )
        (t = n - e.l), (i = e[e.l]), (a = Vn[i] || Vn[hc[i]]), (i === 24 || i === 25) && (a = (i === 24 ? uc : xc)[e[e.l + 1]]), !a || !a.f ? _r(e, t) : s.push([a.n, a.f(e, t, r)]);
    return s;
}
function dc(e) {
    ...
    for (var u = -1, _ = "", O = 0, R = e[0].length; O < R; ++O) {
        ...
        switch (y[0]) {
            ...
            case "PtgAttrIfError":
                break;
            case "PtgRef":
                (c = Tt(y[1][1], s, a)), f.push(Et(c, i));
                break;
            case "PtgRefN":
                (c = r ? Tt(y[1][1], r, a) : y[1][1]), f.push(Et(c, i));
                break;
            case "PtgRef3d":
                (p = y[1][1]), (c = Tt(y[1][2], s, a)), (E = Xn(n, p, a)), f.push(E + "!" + Et(c, i));
                break;
            case "PtgFunc":
            case "PtgFuncVar":
                var M = y[1][0],
            ...
            case "PtgArea":
                ...
                break;
            case "PtgArea3d":
                (p = y[1][1]), (v = y[1][2]), (E = Xn(n, p, a)), f.push(E + "!" + T0(v, a));
                break;
            case "PtgAttrSum":
                f.push("SUM(" + f.pop() + ")");
                break;
            ...
            case "PtgNameX":
                ...
                if (a.biff <= 5) L < 0 && (L = -L), n[L] && (G = n[L][x]);
                    ...
                    if (
                        (((n[L] || [])[0] || [])[0] == 14849 ||
                            (((n[L] || [])[0] || [])[0] == 1025 ? n[L][x] && n[L][x].itab > 0 && (V = n.SheetNames[n[L][x].itab - 1] + "!") : (V = n.SheetNames[x - 1] + "!")),
                        n[L] && n[L][x])
                    )
                        V += n[L][x].Name;
...
function $0(e, t, r) {
    var n = 0,
        a = e.length;
    if (r) {
        if (wt ? r.has(t) : Object.prototype.hasOwnProperty.call(r, t)) {
            for (var i = wt ? r.get(t) : r[t]; n < i.length; ++n) if (e[i[n]].t === t) return e.Count++, i[n];
        }
    } else for (; n < a; ++n) if (e[n].t === t) return e.Count++, n;
    return (e[a] = { t }), e.Count++, e.Unique++, r && (wt ? (r.has(t) || r.set(t, []), r.get(t).push(a)) : (Object.prototype.hasOwnProperty.call(r, t) || (r[t] = []), r[t].push(a))), a;
}
function u0(e, t) {
    ...
    return (
        t.MDW && (yr = t.MDW),
        t.width != null ? (r.customWidth = 1) : t.wpx != null ? (n = r0(t.wpx)) : t.wch != null && (n = t.wch),
        n > -1 ? ((r.width = D0(n)), (r.customWidth = 1)) : t.width != null && (r.width = t.width),
        t.hidden && (r.hidden = !0),
...
var Ic = ["objects", "scenarios", "selectLockedCells", "selectUnlockedCells"],
    Nc = ["formatColumns", "formatRows", "formatCells", "insertColumns", "insertRows", "insertHyperlinks", "deleteColumns", "deleteRows", "sort", "autoFilter", "pivotTables"];
function kc(e) {
    var t = { sheet: 1 };
    return (
        ...
        e.password && (t.password = ja(e.password).toString(16).toUpperCase()),
...
function Lc(e, t) {
    for (var r = ["<cols>"], n, a = 0; a != t.length; ++a) !(n = t[a]) || (r[r.length] = Y("col", null, u0(a, n)));
...
function bc(e, t, r, n) {
    ...
    for (p = s.s.r; p <= s.e.r; ++p) {
        for (i = [], l = He(p), x = s.s.c; x <= s.e.c; ++x) {
            o = c[x] + l;
            var R = E ? (e[p] || [])[x] : e[o];
            R !== void 0 && (f = Uc(R, o, e, t)) != null && i.push(f);
        }
        (i.length > 0 || (v && v[p])) &&
            ((u = { r: l }),
            v &&
                v[p] &&
                ((_ = v[p]), _.hidden && (u.hidden = 1), (O = -1), _.hpx ? (O = t0(_.hpx)) : _.hpt && (O = _.hpt), O > -1 && ((u.ht = O), (u.customHeight = 1)), _.level && (u.outlineLevel = _.level)),
    ...
    if (v)
        for (; p < v.length; ++p)
            v &&
                ...
                _.hidden && (u.hidden = 1),
                (O = -1),
                _.hpx ? (O = t0(_.hpx)) : _.hpt && (O = _.hpt),
...
function xi(e, t, r, n) {
    ...
    Rc(o, r, e, t, a),
        ...
        o["!cols"] != null && o["!cols"].length > 0 && (a[a.length] = Lc(o, o["!cols"])),
        (a[(s = a.length)] = "<sheetData/>"),
        (o["!links"] = []),
        o["!ref"] != null && ((f = bc(o, t)), f.length > 0 && (a[a.length] = f)),
        a.length > s + 1 && ((a[a.length] = "</sheetData>"), (a[s] = a[s].replace("/>", ">"))),
        o["!protect"] && (a[a.length] = kc(o["!protect"])),
        o["!autofilter"] != null && (a[a.length] = Mc(o["!autofilter"], o, r, e)),
        o["!merges"] != null && o["!merges"].length > 0 && (a[a.length] = Dc(o["!merges"]));
    var x = -1,
        v,
        E = -1;
    return (
        o["!links"].length > 0 &&
            ...
            o["!links"].forEach(function (u) {
                !u[1].Target ||
                    ((v = { ref: u[0] }),
                    u[1].Target.charAt(0) != "#" && ((E = pe(n, -1, de(u[1].Target).replace(/#.*$/, ""), he.HLINK)), (v["r:id"] = "rId" + E)),
                    (x = u[1].Target.indexOf("#")) > -1 && (v.location = de(u[1].Target.slice(x + 1))),
                    u[1].Tooltip && (v.tooltip = de(u[1].Tooltip)),
                    (a[a.length] = Y("hyperlink", null, v)));
            }),
            (a[a.length] = "</hyperlinks>")),
        delete o["!links"],
        o["!margins"] != null && (a[a.length] = Pc(o["!margins"])),
        (!t || t.ignoreEC || t.ignoreEC == null) && (a[a.length] = We("ignoredErrors", Y("ignoredError", null, { numberStoredAsText: 1, sqref: l }))),
        p.length > 0 && ((E = pe(n, -1, "../drawings/drawing" + (e + 1) + ".xml", he.DRAW)), (a[a.length] = Y("drawing", null, { "r:id": "rId" + E })), (o["!drawing"] = p)),
        o["!comments"].length > 0 && ((E = pe(n, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", he.VML)), (a[a.length] = Y("legacyDrawing", null, { "r:id": "rId" + E })), (o["!legacy"] = E)),
...
function Hc(e, t, r) {
    ...
    for (var l = { r: e, c: 0 }, c = 0; c < 16; ++c)
        if (!(t.s.c > (c + 1) << 10 || t.e.c < c << 10)) {
            for (var p = -1, x = -1, v = c << 10; v < (c + 1) << 10; ++v) {
                l.c = v;
...
function Qc(e, t, r) {
    return r == null && (r = B(9)), Yr(t, r), r.write_shift(1, e.v ? 1 : 0), r;
}
function e1(e) {
    var t = $r(e),
        r = e.read_shift(1);
...
function n1(e, t, r) {
    return r == null && (r = B(9)), Yr(t, r), r.write_shift(1, e.v), r;
}
function a1(e) {
    var t = $r(e),
        r = e.read_shift(1);
...
function i1(e, t, r) {
    return r == null && (r = B(8)), jr(t, r), r.write_shift(1, e.v), r.write_shift(2, 0), r.write_shift(1, 0), r;
}
function s1(e) {
    var t = or(e),
        r = e.read_shift(4);
...
function f1(e, t, r) {
    return r == null && (r = B(12)), Yr(t, r), r.write_shift(4, t.v), r;
}
function l1(e) {
    var t = $r(e),
        r = e.read_shift(4);
...
function h1(e, t, r) {
    return r == null && (r = B(16)), Yr(t, r), Xr(e.v, r), r;
}
function u1(e) {
    var t = $r(e),
        r = ht(e);
...
function p1(e, t, r) {
    return r == null && (r = B(12)), Yr(t, r), Ra(e.v, r), r;
}
function d1(e) {
    var t = $r(e),
        r = Da(e);
...
function m1(e, t, r) {
    return r == null && (r = B(8)), jr(t, r), Ra(e.v, r), r;
}
function g1(e) {
    var t = or(e),
        r = W0(e);
...
function T1(e, t, r) {
    return r == null && (r = B(12 + 4 * e.v.length)), Yr(t, r), Le(e.v, r), r.length > r.l ? r.slice(0, r.l) : r;
}
function E1(e) {
    var t = $r(e),
        r = Ke(e);
...
function w1(e, t, r) {
    return r == null && (r = B(8 + 4 * e.v.length)), jr(t, r), Le(e.v, r), r.length > r.l ? r.slice(0, r.l) : r;
}
function S1(e, t, r) {
    var n = e.l + t,
        a = or(e);
...
function I1(e, t) {
    ...
    ct({ s: Pe(e[0]), e: Pe(e[0]) }, r), G0("rId" + t, r);
...
function H1(e, t) {
    return (
        t == null && (t = B(16 * 4 + 2)),
        t.write_shift(2, e.password ? ja(e.password) : 0),
        t.write_shift(4, 1),
        [
            ["objects", !1],
            ["scenarios", !1],
...
function X1(e, t, r, n, a, i, s) {
    ...
    var o = { r, c: n };
    switch (((o.s = Mr(a.cellXfs, t, a)), t.l && i["!links"].push([me(o), t.l]), t.c && i["!comments"].push([me(o), t.c]), t.t)) {
        case "s":
        case "str":
            return (
                a.bookSST ? ((f = $0(a.Strings, t.v, a.revStrings)), (o.t = "s"), (o.v = f), s ? W(e, 18, o1(t, o)) : W(e, 7, f1(t, o))) : ((o.t = "str"), s ? W(e, 17, w1(t, o)) : W(e, 6, T1(t, o))),
                !0
            );
        case "n":
            return t.v == (t.v | 0) && t.v > -1e3 && t.v < 1e3 ? (s ? W(e, 13, m1(t, o)) : W(e, 2, p1(t, o))) : s ? W(e, 16, x1(t, o)) : W(e, 5, h1(t, o)), !0;
        case "b":
            return (o.t = "b"), s ? W(e, 15, r1(t, o)) : W(e, 4, Qc(t, o)), !0;
        case "e":
            return (o.t = "e"), s ? W(e, 14, i1(t, o)) : W(e, 3, n1(t, o)), !0;
    }
    return s ? W(e, 12, Zc(t, o)) : W(e, 1, jc(t, o)), !0;
}
function K1(e, t, r, n) {
    var a = Ee(t["!ref"] || "A1"),
        i,
...
function $1(e, t) {
    !t || !t["!ref"] || (W(e, 648), W(e, 649, W1(Ee(t["!ref"]))), W(e, 650));
}
function j1(e, t, r) {
...
function q1(e, t, r) {
    W(e, 133), W(e, 137, b1(t, r)), W(e, 138), W(e, 134);
}
function Q1(e, t) {
    !t["!protect"] || W(e, 535, H1(t["!protect"]));
}
function eh(e, t, r, n) {
    var a = Je(),
        i = r.SheetNames[e],
    ...
    return (
        ...
        (s["!comments"] = []),
        W(a, 129),
        (r.vbaraw || s["!outline"]) && W(a, 147, Yc(f, s["!outline"])),
        W(a, 148, Xc(o)),
        q1(a, s, r.Workbook),
        Y1(a, s),
        K1(a, s, e, t),
        ...
        z1(a, s),
        j1(a, s, n),
        s["!margins"] && W(a, 476, B1(s["!margins"])),
        (!t || t.ignoreEC || t.ignoreEC == null) && $1(a, s),
        J1(a, s, e, n),
        W(a, 130),
        a.end()
    );
...
function nh(e) {
    return !e.Workbook || !e.Workbook.WBProps ? "false" : Ns(e.Workbook.WBProps.date1904) ? "true" : "false";
}
var ah = "][*?/\\".split("");
function pi(e, t) {
    if (e.length > 31) {
...
function sh(e) {
    ...
    ih(e.SheetNames, t, !!e.vbaraw);
    for (var r = 0; r < e.SheetNames.length; ++r) Oc(e.Sheets[e.SheetNames[r]], e.SheetNames[r], r);
}
function di(e) {
    var t = [Re];
        ...
        r &&
            ...
            e.Workbook &&
                ...
                e.Workbook.Names.forEach(function (f) {
                    var o = { name: f.Name };
                    f.Comment && (o.comment = f.Comment), f.Sheet != null && (o.localSheetId = "" + f.Sheet), f.Hidden && (o.hidden = "1"), f.Ref && (t[t.length] = Y("definedName", de(f.Ref), o));
                }),
            (t[t.length] = "</definedNames>")),
...
function xh(e, t) {
    ...
    return Le("SheetJS", t), Le(Kt.version, t), Le(Kt.version, t), Le("7262", t), t.length > t.l ? t.slice(0, t.l) : t;
}
function vh(e, t) {
...
function ph(e, t) {
    if (!(!t.Workbook || !t.Workbook.Sheets)) {
        ...
        i > a || (W(e, 135), W(e, 158, vh(a)), W(e, 136));
    }
}
function dh(e, t) {
    var r = Je();
    return W(r, 131), W(r, 128, xh()), W(r, 153, ch((e.Workbook && e.Workbook.WBProps) || null)), ph(r, e), uh(r, e), W(r, 132), r.end();
}
function mh(e, t, r) {
    return (t.slice(-4) === ".bin" ? dh : di)(e);
}
function gh(e, t, r, n, a) {
    return (t.slice(-4) === ".bin" ? eh : xi)(e, r, n, a);
}
function _h(e, t, r) {
    return (t.slice(-4) === ".bin" ? Ml : qa)(e, r);
}
function Th(e, t, r) {
    return (t.slice(-4) === ".bin" ? ol : $a)(e, r);
}
function Eh(e, t, r) {
    return (t.slice(-4) === ".bin" ? ql : ni)(e);
}
function wh(e) {
    return (e.slice(-4) === ".bin" ? Xl : ri)();
}
function Sh(e, t) {
    var r = [];
    return e.Props && r.push(gf(e.Props, t)), e.Custprops && r.push(_f(e.Props, e.Custprops)), r.join("");
}
function Ah() {
    return "";
}
...
function yh(e) {
    ...
    for (var t = e.Workbook.Names, r = [], n = 0; n < t.length; ++n) {
        var a = t[n];
        a.Sheet == null && (a.Name.match(/^_xlfn\./) || r.push(mi(a)));
    }
...
function Ch(e, t, r, n) {
    ...
    for (var a = n.Workbook.Names, i = [], s = 0; s < a.length; ++s) {
        var f = a[s];
        f.Sheet == r && (f.Name.match(/^_xlfn\./) || i.push(mi(f)));
    }
    return i.join("");
}
function Oh(e, t, r, n) {
    ...
    if (
        (e["!margins"] &&
            (a.push("<PageSetup>"),
            e["!margins"].header && a.push(Y("Header", null, { "x:Margin": e["!margins"].header })),
            e["!margins"].footer && a.push(Y("Footer", null, { "x:Margin": e["!margins"].footer })),
            a.push(
                Y("PageMargins", null, {
    ...
    return (
        ...
        e["!protect"] &&
            ...
            e["!protect"].selectLockedCells != null && !e["!protect"].selectLockedCells
                ...
                : e["!protect"].selectUnlockedCells != null && !e["!protect"].selectUnlockedCells && a.push(We("EnableSelection", "UnlockedCells")),
            [
...
function Rh(e, t, r, n, a, i, s) {
    if (!e || (e.v == null && e.f == null)) return "";
    var f = {};
    if ((e.f && (f["ss:Formula"] = "=" + de(z0(e.f, s))), e.F && e.F.slice(0, t.length) == t)) {
        var o = Pe(e.F.slice(t.length + 1));
        f["ss:ArrayRange"] = "RC:R" + (o.r == s.r ? "" : "[" + (o.r - s.r) + "]") + "C" + (o.c == s.c ? "" : "[" + (o.c - s.c) + "]");
    }
    if ((e.l && e.l.Target && ((f["ss:HRef"] = de(e.l.Target)), e.l.Tooltip && (f["x:HRefScreenTip"] = de(e.l.Tooltip))), r["!merges"]))
    ...
    switch (e.t) {
        ...
        case "e":
            ...
            break;
        case "d":
            (p = "DateTime"), (x = new Date(e.v).toISOString()), e.z == null && (e.z = e.z || ye[14]);
            break;
        case "s":
            (p = "String"), (x = Rs(e.v || ""));
            break;
    }
    var v = Mr(n.cellXfs, e, n);
    (f["ss:StyleID"] = "s" + (21 + v)), (f["ss:Index"] = s.c + 1);
    var E = e.v != null ? x : "",
        u = e.t == "z" ? "" : '<Data ss:Type="' + p + '">' + E + "</Data>";
    return (e.c || []).length > 0 && (u += Dh(e.c)), Y("Cell", u, f);
}
function Ih(e, t) {
...
function Nh(e, t, r, n) {
    ...
    for (var o = Array.isArray(e), l = a.s.r; l <= a.e.r; ++l) {
        for (var c = [Ih(l, (e["!rows"] || [])[l])], p = a.s.c; p <= a.e.c; ++p) {
            var x = !1;
...
function kh(e, t, r) {
    var n = [],
        ...
        i = r.Sheets[a],
        s = i ? Ch(i, t, e, r) : "";
    return s.length > 0 && n.push("<Names>" + s + "</Names>"), (s = i ? Nh(i, t, e, r) : ""), s.length > 0 && n.push("<Table>" + s + "</Table>"), n.push(Oh(i, t, e, r)), n.join("");
}
function Ph(e, t) {
    t || (t = {}),
        e.SSF || (e.SSF = qe(ye)),
        e.SSF && (f0(), s0(e.SSF), (t.revssf = l0(e.SSF)), (t.revssf[e.SSF[65535]] = 0), (t.ssf = e.SSF), (t.cellXfs = []), Mr(t.cellXfs, {}, { revssf: { General: 0 } }));
    var r = [];
    r.push(Sh(e, t)), r.push(Ah()), r.push(""), r.push("");
    for (var n = 0; n < e.SheetNames.length; ++n) r.push(Y("Worksheet", kh(n, t, e), { "ss:Name": de(e.SheetNames[n]) }));
    return (
        (r[2] = Fh(e, t)),
        (r[3] = yh(e)),
        Re +
    ...
    if (e.Custprops)
        for (s = Ge(e.Custprops), i = 0; i < s.length; ++i)
            Object.prototype.hasOwnProperty.call(e.Props || {}, s[i]) ||
                (Object.prototype.hasOwnProperty.call(f, s[i]) ? r : Object.prototype.hasOwnProperty.call(o, s[i]) ? n : a).push([s[i], e.Custprops[s[i]]]);
    var l = [];
    for (i = 0; i < a.length; ++i) Ha.indexOf(a[i][0]) > -1 || Ua.indexOf(a[i][0]) > -1 || (a[i][1] != null && l.push(a[i]));
    n.length && _e.utils.cfb_add(t, "/SummaryInformation", Mn(n, S0.SI, o, In)),
        (r.length || l.length) && _e.utils.cfb_add(t, "/DocumentSummaryInformation", Mn(r, S0.DSI, f, Rn, l.length ? l : null, S0.UDI));
}
function Mh(e, t) {
    var r = t || {},
    ...
    return (
        _e.utils.cfb_add(n, a, gi(e, r)),
        r.biff == 8 && (e.Props || e.Custprops) && Lh(e, n),
        r.biff == 8 &&
            e.vbaraw &&
            Ql(
                n,
...
function J(e, t, r, n) {
    ...
    if (!isNaN(a)) {
        var i = n || (r || []).length || 0,
            s = e.next(4);
        s.write_shift(2, a), s.write_shift(2, i), i > 0 && B0(r) && e.push(r);
    }
}
function Uh(e, t, r, n) {
    var a = n || (r || []).length || 0;
    ...
    var i = t;
    if (!isNaN(i)) {
        for (var s = r.parts || [], f = 0, o = 0, l = 0; l + (s[f] || 8224) <= 8224; ) (l += s[f] || 8224), f++;
        var c = e.next(4);
        for (c.write_shift(2, i), c.write_shift(2, l), e.push(r.slice(o, o + l)), o += l; o < a; ) {
            for (c = e.next(4), c.write_shift(2, 60), l = 0; l + (s[f] || 8224) <= 8224; ) (l += s[f] || 8224), f++;
...
function bh(e, t, r, n) {
    var a = B(9);
    return Pt(a, e, t), Va(r, n || "b", a), a;
}
function Wh(e, t, r) {
    var n = B(8 + 2 * r.length);
    return Pt(n, e, t), n.write_shift(1, r.length), n.write_shift(r.length, r, "sbcs"), n.l < n.length ? n.slice(0, n.l) : n;
}
function Hh(e, t, r, n) {
    if (t.v != null)
        switch (t.t) {
            ...
            case "n":
                ...
                a == (a | 0) && a >= 0 && a < 65536 ? J(e, 2, el(r, n, a)) : J(e, 3, Qf(r, n, a));
                return;
            case "b":
            case "e":
                J(e, 5, bh(r, n, t.v, t.t));
                return;
            case "s":
            case "str":
                J(e, 4, Wh(r, n, (t.v || "").slice(0, 255)));
                return;
        }
    J(e, 1, Pt(null, r, n));
}
...
function Vh(e, t) {
    ...
    return J(n, r.biff == 4 ? 1033 : r.biff == 3 ? 521 : 9, V0(e, 16, r)), Gh(n, e.Sheets[e.SheetNames[a]], a, r), J(n, 10), n.end();
}
function Xh(e, t, r) {
    J(
        e,
...
function Kh(e, t, r) {
    !t ||
        [
            ...
            for (var a = n[0]; a <= n[1]; ++a) t[a] != null && J(e, 1054, bf(a, t[a], r));
        });
}
function zh(e, t) {
    var r = B(19);
...
function $h(e, t) {
    for (var r = 0; r < t["!links"].length; ++r) {
        var n = t["!links"][r];
        J(e, 440, Yf(n)), n[1].Tooltip && J(e, 2048, $f(n));
    }
    delete t["!links"];
}
function jh(e, t) {
        ...
        switch (t.t) {
            ...
            case "str":
                if (a.bookSST) {
                    ...
                    J(e, 253, Bf(r, n, f, i));
                } else J(e, 516, Uf(r, n, (t.v || "").slice(0, 255), i, a));
                break;
            default:
                J(e, 513, Kr(r, n, i));
        }
...
function Zh(e, t, r) {
    ...
    for (var u = v.s.r; u <= v.e.r; ++u) {
        ...
        for (var _ = v.s.c; _ <= v.e.c; ++_) {
            u === v.s.r && (x[_] = Xe(_)), (c = x[_] + p);
            var O = o ? (i[u] || [])[_] : i[c];
            !O || (Jh(n, O, u, _, t), l && O.l && i["!links"].push([c, O.l]));
        }
    }
    var R = f.CodeName || f.name || a;
    return l && J(n, 574, Lf((s.Views || [])[0])), l && (i["!merges"] || []).length && J(n, 229, zf(i["!merges"])), l && $h(n, i), J(n, 442, Ka(R)), l && zh(n, i), J(n, 10), n.end();
}
function qh(e, t, r) {
    var n = Je(),
        a = (e || {}).Workbook || {},
    ...
    if (
        ...
        f && J(n, 353, lr(0)),
        f && J(n, 448),
        J(n, 317, qf(e.SheetNames.length)),
        f && e.vbaraw && J(n, 211),
        f && e.vbaraw)
    ) {
    ...
    var c = n.end(),
        p = Je();
    f && J(p, 140, jf()), f && r.Strings && Uh(p, 252, kf(r.Strings)), J(p, 10);
    var x = p.end(),
        v = Je(),
        E = 0,
        u = 0;
    ...
    for (u = 0; u < e.SheetNames.length; ++u) {
        var O = i[u] || {};
        J(v, 133, Nf({ pos: _, hs: O.Hidden || 0, dt: 0, name: e.SheetNames[u] }, r)), (_ += t[u].length);
    }
    var R = v.end();
...
function Qh(e, t) {
    var r = t || {},
        n = [];
    e && !e.SSF && (e.SSF = qe(ye)),
        e && e.SSF && (f0(), s0(e.SSF), (r.revssf = l0(e.SSF)), (r.revssf[e.SSF[65535]] = 0), (r.ssf = e.SSF)),
        (r.Strings = []),
        (r.Strings.Count = 0),
        (r.Strings.Unique = 0),
        j0(r),
        ...
        e.Props || (e.Props = {});
    for (var a = 0; a < e.SheetNames.length; ++a) n[n.length] = Zh(a, r, e);
    return n.unshift(qh(e, n, r)), be(n);
}
function gi(e, t) {
...
function eu(e, t, r, n) {
    for (var a = e["!merges"] || [], i = [], s = t.s.c; s <= t.e.c; ++s) {
        ...
        if (!(f < 0)) {
            var c = me({ r, c: s }),
                p = n.dense ? (e[r] || [])[s] : e[c],
                x = (p && p.v != null && (p.h || Ds(p.w || (Or(p), p.w) || ""))) || "",
                v = {};
            f > 1 && (v.rowspan = f),
                o > 1 && (v.colspan = o),
                n.editable
                    ...
                    : p &&
                      ((v["data-t"] = (p && p.t) || "z"),
                      p.v != null && (v["data-v"] = p.v),
                      p.z != null && (v["data-z"] = p.z),
                      p.l && (p.l.Target || "#").charAt(0) != "#" && (x = '<a href="' + p.l.Target + '">' + x + "</a>")),
                (v.id = (n.id || "sjs") + "-" + c),
                i.push(Y("td", x, v));
        }
    }
...
function _i(e, t) {
    var r = t || {},
        ...
        a = r.footer != null ? r.footer : tu,
        i = [n],
        s = ar(e["!ref"]);
    (r.dense = Array.isArray(e)), i.push(nu(e, s, r));
    for (var f = s.s.r; f <= s.e.r; ++f) i.push(eu(e, s, f, r));
...
function Ti(e, t, r) {
    ...
    for (e["!cols"] || (e["!cols"] = []); E < f.length && u < o; ++E) {
        ...
        for (_ = O = 0; _ < j.length; ++_) {
            var ee = j[_];
            if (!(n.display && Kn(ee))) {
                var C = ee.hasAttribute("data-v") ? ee.getAttribute("data-v") : ee.hasAttribute("v") ? ee.getAttribute("v") : ks(ee.innerHTML),
                    ...
                    (C.length == 0
                        ...
                        : n.raw ||
                          ...
                          (C === "TRUE"
                              ...
                              ? (G = { t: "b", v: !1 })
                              : isNaN(Fr(C))
                              ? isNaN(Ft(C).getDate()) || ((G = { t: "d", v: je(C) }), n.cellDates || (G = { t: "n", v: Ze(G.v) }), (G.z = n.dateNF || ye[14]))
                              : (G = { t: "n", v: Fr(C) }))),
                    G.z === void 0 && b != null && (G.z = b);
                var K = "",
                    re = ee.getElementsByTagName("A");
                if (re && re.length) for (var ge = 0; ge < re.length && !(re[ge].hasAttribute("href") && ((K = re[ge].getAttribute("href")), K.charAt(0) != "#")); ++ge);
                K && K.charAt(0) != "#" && (G.l = { Target: K }),
                    n.dense ? (e[u + a] || (e[u + a] = []), (e[u + a][O + i] = G)) : (e[me({ c: O + i, r: u + a })] = G),
                    l.e.c < O + i && (l.e.c = O + i),
                    (O += y);
            }
        }
...
`
                    ...
                    for (; c <= p.e.c; ++c) {
                        ...
                        var M = me({ r: l, c }),
                            j = E ? (i[l] || [])[c] : i[M];
                        if (j && j.f && ((R["table:formula"] = de(yc(j.f))), j.F && j.F.slice(0, M.length) == M)) {
                            var ee = ar(j.F);
...
`
                  ...
                  o.push(Ma().replace(/office:document-meta/g, "office:meta")))
                : o.push(
...
/*! sheetjs (C) 2013-present SheetJS -- http://sheetjs.com */ function n0(e) {
    ...
    for (var t = [], r = [0]; r[0] < e.length; ) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                break;
            case 2:
                (s = Ct(e, r)), (f = e.slice(r[0], r[0] + s)), (r[0] += s);
                break;
            case 3:
            case 4:
            default:
...
function cu(e, t) {
    ...
    for (var r = [0], n = Ct(t, r), a = []; r[0] < t.length; ) {
        var i = t[r[0]] & 3;
        if (i == 0) {
            var s = t[r[0]++] >> 2;
            if (s < 60) ++s;
            ...
            if (
                (i == 1
                    ...
                    : ((l = (t[r[0]++] >> 2) + 1),
                      i == 2 ? ((o = t[r[0]] | (t[r[0] + 1] << 8)), (r[0] += 2)) : ((o = (t[r[0]] | (t[r[0] + 1] << 8) | (t[r[0] + 2] << 16) | (t[r[0] + 3] << 24)) >>> 0), (r[0] += 4))),
                (a = [Lr(a)]),
                o == 0)
            )
                throw new Error("Invalid offset 0");
            if (o > a[0].length) throw new Error("Invalid offset beyond length");
            if (l >= o) for (a.push(a[0].slice(-o)), l -= o; l >= a[a.length - 1].length; ) a.push(a[a.length - 1]), (l -= a[a.length - 1].length);
...
function ur(e) {
    for (var t = [], r = 0; r < e.length; ) {
        ...
        (r += 3), t.push(cu(n, e.slice(r, r + a))), (r += a);
    }
    ...
    for (var t = [], r = 0; r < e.length; ) {
        ...
        t.push(i),
            n <= 60
                ...
                : n <= 16777216
                ? ((s += 4), t.push(new Uint8Array([248, (n - 1) & 255, ((n - 1) >> 8) & 255, ((n - 1) >> 16) & 255])))
                : n <= 4294967296 && ((s += 5), t.push(new Uint8Array([252, (n - 1) & 255, ((n - 1) >> 8) & 255, ((n - 1) >> 16) & 255, ((n - 1) >>> 24) & 255]))),
...
function Rr(e) {
    var t = Ie(e);
    return Ct(t[1][0].data);
}
function hu(e, t, r) {
    var n, a, i, s;
    if (!((n = e[6]) != null && n[0]) || !((a = e[7]) != null && a[0])) throw "Mutation only works on post-BNC storages!";
    var f = (((s = (i = e[8]) == null ? void 0 : i[0]) == null ? void 0 : s.data) && st(e[8][0].data) > 0) || !1;
    if (f) throw "Math only works with normal offsets";
    for (var o = 0, l = n0(e[7][0].data), c = 0, p = [], x = n0(e[4][0].data), v = 0, E = [], u = 0; u < t.length; ++u) {
        if (t[u] == null) {
        ...
        p.push(_), (c += _.length), E.push(O), (v += O.length), ++o;
    }
    for (e[2][0].data = ve(o); u < e[7][0].data.length / 2; ++u) l.setUint16(u * 2, 65535, !0), x.setUint16(u * 2, 65535, !0);
    return (e[6][0].data = Lr(p)), (e[3][0].data = Lr(E)), o;
}
function uu(e, t) {
                ...
                H.messages.forEach(function (ie) {
                    c.forEach(function (se) {
                        H.messages.some(function (ae) {
                            return st(ae.meta[1][0].data) != 11006 && lu(ae.data, se[1]);
    ...
    for (var p = _e.find(l, f[1].location), x = hr(ur(p.content)), v, E = 0; E < x.length; ++E) {
        var u = x[E];
        u.id == 1 && (v = u);
    }
    var _ = Rr(Ie(v.messages[0].data)[1][0].data);
    for (p = _e.find(l, f[_].location), x = hr(ur(p.content)), E = 0; E < x.length; ++E) (u = x[E]), u.id == _ && (v = u);
    for (_ = Rr(Ie(v.messages[0].data)[2][0].data), p = _e.find(l, f[_].location), x = hr(ur(p.content)), E = 0; E < x.length; ++E) (u = x[E]), u.id == _ && (v = u);
    for (_ = Rr(Ie(v.messages[0].data)[2][0].data), p = _e.find(l, f[_].location), x = hr(ur(p.content)), E = 0; E < x.length; ++E) (u = x[E]), u.id == _ && (v = u);
        ...
        var G = Ie(O[4][0].data);
        {
            ...
            (y = _e.find(l, f[K].location)), (M = hr(ur(y.content)));
            {
                ...
                for (L = 0; L < i.length; ++L) {
                    ...
                    (ge[1][0].data = ve(L)), (ge[4][0].data = ve(i[L].length)), (re[2][L] = { type: re[2][0].type, data: Be(ge) });
                }
            ...
            (y = _e.find(l, f[le].location)), (M = hr(ur(y.content)));
            {
                ...
                for (re = Ie(M[0].messages[0].data), C = 0; C <= n.e.c; ++C)
                    (ge = Ie(re[2][0].data)), (ge[1][0].data = ve(C)), (ge[4][0].data = ve(n.e.r + 1)), (re[2][C] = { type: re[2][0].type, data: Be(ge) });
                M[0].messages[0].data = Be(re);
            }
            (y.content = et(Qr(M))), (y.size = y.content.length);
            ...
            (function () {
                ...
                var se = Ie(A.messages[0].data);
                {
                    ...
                    s.forEach(function (ce, ze) {
                        (ae[1] = [{ type: 0, data: ve(ze) }]), (ae[2] = [{ type: 0, data: ve(1) }]), (ae[3] = [{ type: 2, data: fu(ce) }]), se[3].push({ type: 2, data: Be(ae) });
                    });
                }
                    ...
                    (function () {
                        ...
                        var se = Ie(A.messages[0].data);
                        {
                            ...
                            for (var q = 0, Te = 0; Te <= n.e.r; ++Te) {
                                var ce = Ie(ae);
                                (q += hu(ce, i[Te], s)), (ce[1][0].data = ve(Te)), se[5].push({ data: Be(ce), type: 2 });
                            }
...
function vu(e, t) {
    return t.bookType == "ods" ? wi(e, t) : t.bookType == "numbers" ? uu(e, t) : t.bookType == "xlsb" ? pu(e, t) : du(e, t);
}
function pu(e, t) {
    (tt = 1024),
        e && !e.SSF && (e.SSF = qe(ye)),
        e && e.SSF && (f0(), s0(e.SSF), (t.revssf = l0(e.SSF)), (t.revssf[e.SSF[65535]] = 0), (t.ssf = e.SSF)),
        (t.rels = {}),
        (t.wbrels = {}),
        (t.Strings = []),
        (t.Strings.Count = 0),
        (t.Strings.Unique = 0),
        wt ? (t.revStrings = new Map()) : ((t.revStrings = {}), (t.revStrings.foo = []), delete t.revStrings.foo);
    var r = t.bookType == "xlsb" ? "bin" : "xml",
        n = ai.indexOf(t.bookType) > -1,
        a = ka();
    j0((t = t || {}));
    var i = k0(),
        s = "",
    ...
    for (
        e.Props.Worksheets = e.Props.SheetNames.length,
            ...
            e.Custprops !== e.Props && Ge(e.Custprops || {}).length > 0 && ((s = "docProps/custom.xml"), oe(i, s, Wa(e.Custprops)), a.custprops.push(s), pe(t.rels, 4, s, he.CUST_PROPS)),
            f = 1;
        ...
        switch (x) {
            case "chart":
            default:
                (s = "xl/worksheets/sheet" + f + "." + r), oe(i, s, gh(f - 1, s, t, e, c)), a.sheets.push(s), pe(t.wbrels, -1, "worksheets/sheet" + f + "." + r, he.WS[0]);
        }
        if (p) {
            var v = p["!comments"],
                E = !1,
                u = "";
            v && v.length > 0 && ((u = "xl/comments" + f + "." + r), oe(i, u, Eh(v, u)), a.comments.push(u), pe(c, -1, "../comments" + f + "." + r, he.CMNT), (E = !0)),
                p["!legacy"] && E && oe(i, "xl/drawings/vmlDrawing" + f + ".vml", ti(f, p["!comments"])),
                delete p["!comments"],
                delete p["!legacy"];
        }
        c["!id"].rId1 && oe(i, La(s), at(c));
    }
    return (
        t.Strings != null && t.Strings.length > 0 && ((s = "xl/sharedStrings." + r), oe(i, s, Th(t.Strings, s, t)), a.strs.push(s), pe(t.wbrels, -1, "sharedStrings." + r, he.SST)),
        (s = "xl/workbook." + r),
        oe(i, s, mh(e, s)),
        a.workbooks.push(s),
        pe(t.rels, 1, s, he.WB),
        (s = "xl/theme/theme1.xml"),
        oe(i, s, ei(e.Themes, t)),
        a.themes.push(s),
        ...
        e.vbaraw && n && ((s = "xl/vbaProject.bin"), oe(i, s, e.vbaraw), a.vba.push(s), pe(t.wbrels, -1, "vbaProject.bin", he.VBA)),
        (s = "xl/metadata." + r),
        oe(i, s, wh(s)),
        a.metadata.push(s),
        pe(t.wbrels, -1, "metadata." + r, he.XLMETA),
        oe(i, "[Content_Types].xml", Pa(a, t)),
...
function du(e, t) {
    ...
    for (t.tcid = 0, f = 1; f <= e.SheetNames.length; ++f) {
        ...
        switch (v) {
            case "chart":
            default:
                (s = "xl/worksheets/sheet" + f + "." + r), oe(i, s, xi(f - 1, t, e, p)), a.sheets.push(s), pe(t.wbrels, -1, "worksheets/sheet" + f + "." + r, he.WS[0]);
        }
        if (x) {
            var E = x["!comments"],
                u = !1,
            ...
            if (E && E.length > 0) {
                ...
                E.forEach(function (R) {
                    ...
                    O &&
                        ...
                        pe(p, -1, "../threadedComments/threadedComment" + f + "." + r, he.TCMNT)),
                    (_ = "xl/comments" + f + "." + r),
                    oe(i, _, ni(E)),
                    a.comments.push(_),
                    pe(p, -1, "../comments" + f + "." + r, he.CMNT),
                    (u = !0);
            }
            x["!legacy"] && u && oe(i, "xl/drawings/vmlDrawing" + f + ".vml", ti(f, x["!comments"])), delete x["!comments"], delete x["!legacy"];
        }
        p["!id"].rId1 && oe(i, La(s), at(p));
    }
    return (
        t.Strings != null && t.Strings.length > 0 && ((s = "xl/sharedStrings." + r), oe(i, s, $a(t.Strings, t)), a.strs.push(s), pe(t.wbrels, -1, "sharedStrings." + r, he.SST)),
        (s = "xl/workbook." + r),
        oe(i, s, di(e)),
        a.workbooks.push(s),
        pe(t.rels, 1, s, he.WB),
        ...
        a.metadata.push(s),
        pe(t.wbrels, -1, "metadata." + r, he.XLMETA),
        c.length > 1 && ((s = "xl/persons/person.xml"), oe(i, s, Yl(c)), a.people.push(s), pe(t.wbrels, -1, "persons/person.xml", he.PEOPLE)),
        oe(i, "[Content_Types].xml", Pa(a, t)),
        oe(i, "_rels/.rels", at(t.rels)),
        oe(i, "xl/_rels/workbook." + r + ".rels", at(t.wbrels)),
        delete t.revssf,
...
function Si(e, t) {
    switch (t.type) {
        ...
        case "array":
            ...
            break;
        case "file":
            return Rt(t.file, _e.write(e, { type: ue ? "buffer" : "" }));
        case "string":
...
function _u(e, t) {
    ...
    return t.password && typeof encrypt_agile < "u" ? Si(encrypt_agile(a, t.password), t) : t.type === "file" ? Rt(t.file, a) : t.type == "string" ? gt(a) : a;
}
function Tu(e, t) {
    var r = t || {},
        n = Mh(e, r);
...
function Xt(e, t) {
    switch (t.type) {
        ...
        case "binary":
            ...
            return t.type == "base64" ? At(r) : t.type == "string" ? gt(r) : r;
        case "file":
            return Rt(t.file, e);
        case "buffer":
            return e;
...
function Ai(e, t) {
    ...
    var a = 0;
    if (r.sheet && (typeof r.sheet == "number" ? (a = r.sheet) : (a = e.SheetNames.indexOf(r.sheet)), !e.SheetNames[a])) throw new Error("Sheet not found: " + r.sheet + " : " + typeof r.sheet);
    switch (r.bookType || "xlsb") {
        ...
        case "slk":
        case "sylk":
            return gr(tl.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "htm":
        case "html":
            return gr(_i(e.Sheets[e.SheetNames[a]], r), r);
        case "txt":
            return Eu(Fi(e.Sheets[e.SheetNames[a]], r), r);
        case "csv":
            return gr(J0(e.Sheets[e.SheetNames[a]], r), r, "\uFEFF");
        case "dif":
            return gr(nl.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "dbf":
            return Xt(rl.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "prn":
            return gr(al.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "rtf":
            return gr(hl.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "eth":
            return gr(Ya.from_sheet(e.Sheets[e.SheetNames[a]], r), r);
        case "fods":
            return gr(wi(e, r), r);
        case "wk1":
            return Xt(bn.sheet_to_wk1(e.Sheets[e.SheetNames[a]], r), r);
        case "wk3":
            return Xt(bn.book_to_wk3(e, r), r);
        case "biff2":
            r.biff || (r.biff = 2);
        case "biff3":
            r.biff || (r.biff = 3);
        case "biff4":
            return r.biff || (r.biff = 4), Xt(gi(e, r), r);
        case "biff5":
            r.biff || (r.biff = 5);
        case "biff8":
        case "xla":
        case "xls":
            return r.biff || (r.biff = 8), Tu(e, r);
        case "xlsx":
        case "xlsm":
        case "xlam":
        case "xlsb":
...
function Lu(e, t, r) {
    var n = r || {};
    return (n.type = "file"), (n.file = t), wu(n), Ai(e, n);
}
    ...
    if (!s || e[r])
        for (var v = t.s.c; v <= t.e.c; ++v) {
            ...
            if (i[v] != null) {
                ...
                else x[i[v]] = c && (E.t !== "n" || (E.t === "n" && f.rawNumbers !== !1)) ? u : Or(E, u, f);
                u != null && (p = !1);
            }
        }
...
function a0(e, t) {
    ...
    for (R = o.s.c; R <= o.e.c; ++R)
        if (!(M[R] || {}).hidden)
            switch (((x[R] = Xe(R)), (r = _ ? e[O][R] : e[x[R] + p]), n)) {
                case 1:
                    i[R] = R - o.s.c;
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                default:
                    if ((r == null && (r = { w: "__EMPTY", t: "s" }), (f = s = Or(r, null, l)), (u = y[s] || 0), !u)) y[s] = 1;
                    else {
                        do f = s + "_" + u++;
                        while (y[f]);
                        (y[s] = u), (y[f] = 1);
    ...
    for (O = o.s.r + a; O <= o.e.r; ++O)
        if (!(j[O] || {}).hidden) {
            var ee = Su(e, o, O, x, n, i, _, l);
            (ee.isempty === !1 || (n === 1 ? l.blankrows !== !1 : !!l.blankrows)) && (v[E++] = ee.row);
        }
    return (v.length = E), v;
}
var Yn = /"/g;
function Au(e, t, r, n, a, i, s, f) {
    for (var o = !0, l = [], c = "", p = He(r), x = t.s.c; x <= t.e.c; ++x)
        if (!!n[x]) {
            var v = f.dense ? (e[r] || [])[x] : e[n[x] + p];
            if (v == null) c = "";
            else if (v.v != null) {
                (o = !1), (c = "" + (f.rawNumbers && v.t == "n" ? v.v : Or(v, null, f)));
...
`,
    ...
    for (var x = (n.skipHidden && e["!cols"]) || [], v = (n.skipHidden && e["!rows"]) || [], E = a.s.c; E <= a.e.c; ++E) (x[E] || {}).hidden || (p[E] = Xe(E));
    for (var u = 0, _ = a.s.r; _ <= a.e.r; ++_)
        (v[_] || {}).hidden || ((c = Au(e, a, _, p, s, o, i, n)), c != null && (n.strip && (c = c.replace(l, "")), (c || n.blankrows !== !1) && r.push((u++ ? f : "") + c)));
            ...
            (l = Ot(i, j)),
                R && typeof R == "object" && !(R instanceof Date)
                    ...
                    : (typeof R == "number"
                          ...
                          ? (y = "s")
                          : R instanceof Date
                          ? ((y = "d"), n.cellDates || ((y = "n"), (R = Ze(R))), (M = n.dateNF || ye[14]))
                          : R === null && n.nullError && ((y = "e"), (R = 0)),
                      l ? ((l.t = y), (l.v = R), delete l.w, delete l.R, M && (l.z = M)) : (i[j] = l = { t: y, v: R }),
                      M && (l.z = M));
        });
    }),
...
function Ot(e, t, r) {
    ...
    return typeof t != "number" ? Ot(e, me(t)) : Ot(e, me({ r: t, c: r || 0 }));
}
function Cu(e, t) {
    if (typeof t == "number") {
...
function Du(e, t, r, n) {
    ...
    if ((pi(r), e.SheetNames.indexOf(r) >= 0)) throw new Error("Worksheet with name |" + r + "| already exists!");
...
var Mu = {
    ...
    sheet_to_json: a0,
    sheet_to_html: _i,
    sheet_to_formulae: Fu,
    sheet_to_row_object_array: a0,
    sheet_get_cell: Ot,
    book_new: Ou,
    book_append_sheet: Du,
    book_set_sheet_visibility: Ru,
    cell_set_number_format: Iu,
    cell_set_hyperlink: Ci,
    cell_set_internal_link: Nu,
    cell_add_comment: ku,
    sheet_set_array_formula: Pu,
    consts: { SHEET_VISIBLE: 0, SHEET_HIDDEN: 1, SHEET_VERY_HIDDEN: 2 },
};
export { Mu as u, Lu as w };
