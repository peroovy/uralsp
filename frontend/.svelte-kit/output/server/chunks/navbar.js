...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.paricipantName === void 0 && $$bindings.paricipantName && paricipantName !== void 0)
    $$bindings.paricipantName(paricipantName);
  if ($$props.active === void 0 && $$bindings.active && active !== void 0)
    $$bindings.active(active);
  $$result.css.add(css);
  $$unsubscribe_page();
  return `<div class="${"participant-container svelte-1fotc2p"}"><nav class="${"navbar navbar-expand-lg navbar-light mb-5 sticky-top shadow svelte-1fotc2p"}"><div class="${"container-fluid p-0 d-flex justify-content-lg-around"}"><div class="${"navbar-brand svelte-1fotc2p"}"><img${add_attribute("src", src, 0)} alt="${"Logo"}" class="${"svelte-1fotc2p"}"></div>
      ...
      <div class="${"collapse navbar-collapse flex-grow-0"}" id="${"participant-menu"}"><ul class="${"navbar-nav me-auto mb-20 mb-lg-0 col-12 justify-content-around svelte-1fotc2p"}"><li class="${"nav-item svelte-1fotc2p"}"><span class="${"nav-link active"}"${add_attribute("this", up, 0)}>Upcoming registeration </span></li>
          ...
          <li class="${"nav-item dropdown svelte-1fotc2p"}"><div class="${"nav-link dropdown-toggle d-flex align-items-center"}" role="${"button"}" data-bs-toggle="${"dropdown"}" aria-expanded="${"false"}"><img${add_attribute("src", tempPhoto, 0)} alt="${"Logo"}" class="${"part-photo svelte-1fotc2p"}">
              <span>${escape(paricipantName)}</span></div>
            <ul class="${"dropdown-menu mt-2 ms-3 rounded-0 svelte-1fotc2p"}"><li${add_classes(($page.url.pathname === "/info" ? "active" : "").trim())}><a sveltekit:prefetch href="${escape(base, true) + "/info/" + escape(userId, true)}" target="${"_blank"}" content="${"Home"}" class="${"dropdown-item nav-link svelte-1fotc2p"}"><span class="${"fa fa-gears svelte-1fotc2p"}"></span>
                  Settings
                </a></li>
