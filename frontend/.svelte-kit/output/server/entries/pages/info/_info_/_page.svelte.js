...
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.size === void 0 && $$bindings.size && size !== void 0)
    $$bindings.size(size);
  if ($$props.authType === void 0 && $$bindings.authType && authType !== void 0)
    $$bindings.authType(authType);
  if ($$props.redirectURL === void 0 && $$bindings.redirectURL && redirectURL !== void 0)
    $$bindings.redirectURL(redirectURL);
  if ($$props.requestAccess === void 0 && $$bindings.requestAccess && requestAccess !== void 0)
    $$bindings.requestAccess(requestAccess);
  if ($$props.buttonRadius === void 0 && $$bindings.buttonRadius && buttonRadius !== void 0)
    $$bindings.buttonRadius(buttonRadius);
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  instFacultyName = "";
  $$unsubscribe_page();
  return `${$$result.head += `<meta name="${"description"}" content="${"Some description!"}" data-svelte="svelte-1b57mjl"><link rel="${"stylesheet"}" href="${"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"}" data-svelte="svelte-1b57mjl">${$$result.title = `<title>App Name | ${escape(userInfo.name)} ${escape(userInfo.surname)}</title>`, ""}<script async defer src="${"https://vk.com/js/api/openapi.js"}" type="${"text/javascript"}" charset="${"windows-1251"}" data-svelte="svelte-1b57mjl"><\/script>`, ""}
...
<section class="${"user-info svelte-zs98s6"}"><img class="${"d1 svelte-zs98s6"}"${add_attribute("src", dotsSrc, 0)} alt="${""}">
  ...
  <div class="${"container d-flex justify-content-center mt-5"}"><div class="${"row p-0 m-0 col-12 justify-content-center"}"><div class="${"card shadow col-lg-6 svelte-zs98s6"}"><h5 class="${"card-title m-4 mt-4 svelte-zs98s6"}"><i class="${"fa fa-info-circle"}"></i>
        ...
        <div class="${"card-body ms-4"}">
          ...
          <div class="${"form-group d-flex gap-3 col-md-11"}"><input type="${"text"}" class="${"form-control svelte-zs98s6"}" id="${"name"}" placeholder="${"Enter first name"}"${add_attribute("value", userInfo.name, 0)}>
          ...
          <div class="${"form-group col-md-11"}"><label for="${"Email Address"}">Email address</label>
            <input type="${"email"}" class="${"form-control svelte-zs98s6"}" id="${"Email Address"}" aria-describedby="${"emailHelp"}" placeholder="${"Enter email"}"${add_attribute("value", userInfo.email, 0)}>
          ...
          <div class="${"form-group col-md-11"}"><label for="${"Email Address"}">User ID</label>
            <input type="${"email"}" class="${"form-control svelte-zs98s6"}" id="${"Email Address"}" aria-describedby="${"emailHelp"}" placeholder="${"Enter email"}" disabled${add_attribute("value", id, 0)}>
          ...
          <div class="${"form-group col-md-11"}"><label for="${"phoneNumber"}">Phone Number</label>
            <div class="${"input-group mb-3"}"><div class="${"input-group-prepend "}"><span class="${"input-group-text rounded-0 bg-white svelte-zs98s6"}" id="${"basic-addon3"}"><img${add_attribute("src", russianFlag, 0)} alt="${"The Russian flag"}" class="${"flag svelte-zs98s6"}"></span></div>
              <input type="${"text"}" class="${"form-control svelte-zs98s6"}" id="${"phoneNumber"}" placeholder="${"Enter phone number"}" data-mask="${"+7"}"${add_attribute("value", userInfo.phone, 0)}></div></div></div>
        ...
        <div class="${"card-body ms-4"}"><div class="${"form-group col-md-11"}"><label for="${"region"}">Region</label>
            <select class="${"form-select form-select-sm svelte-zs98s6"}" aria-label="${"Default select example"}"><option selected value="${"Choose..."}">Choose...</option>${each(republics, (republic) => {
    return `<option${add_attribute("value", republic, 0)}>${escape(republic)}</option>`;
        ...
        <div class="${"card-body ms-4"}"><div class="${"form-group col-md-11"}"><label for="${"education"}">Education type</label>
          ...
          ${educationType === "School" ? `<div class="${"d-flex col-md-11"}"><div class="${"form-group col-md-11 justify-content-between"}"><div class="${"row col-md-11 m-0 justify-content-between"}"><div class="${"form-group p-0 col-md-7"}"><label for="${"school"}">School Name</label>
                  ...
                  <div class="${"form-group p-0 col-md-4"}"><label for="${"schoolYear"}">School Year</label>
                    <select class="${"form-select form-select svelte-zs98s6"}" aria-label="${"Default select example"}"><option selected value="${"Choose..."}">Choose...</option>${each(Array(11), (_, i) => {
    return `<option${add_attribute("value", i + 1, 0)}>${escape(i + 1)}</option>`;
  })}</select></div></div></div></div>` : ``}
          ${educationType === "University" ? `<div class="${"d-flex col-md-11 justify-content-between p-0"}"><div class="${"row"}"><div class="${"form-group col-md-8"}"><label for="${"Institute"}">Institute Name</label>
    ...
    return `<option${add_attribute("value", grade, 0)}>${escape(grade)}</option>`;
          ...
          ${educationType == "College" ? `<div class="${"d-flex col-md-11 justify-content-between p-0"}"><div class="${"row"}"><div class="${"form-group col-md-8"}"><label for="${"Institute"}">College name</label>
                  <input type="${"text"}" class="${"form-control svelte-zs98s6"}" id="${"Institute"}" placeholder="${"Enter your Institute name"}"${add_attribute("value", instName, 0)}></div>
    ...
    return `<option${add_attribute("value", grade, 0)}>${escape(grade)}</option>`;
        ...
        ${real_id != userInfo.id ? `<h5 class="${"card-title m-4 mt-2 svelte-zs98s6"}"><i class="${"fa-solid fa-lock"}"></i>
            Permission
          </h5>
          <div class="${"card-body ms-4 mt-0"}"><label for="${"region"}">Permission</label>
            <select class="${"form-select form-select-sm svelte-zs98s6"}" aria-label="${"Default select example"}"><option selected value="${"Choose..."}">Choose...</option>${each(permissionsArr, (per) => {
    return `<option${add_attribute("value", per, 0)}>${escape(per)}</option>`;
        ...
        <div class="${"card-body pt-0 mt-0 d-flex justify-content-center align-items-center"}"><div class="${"btn-group gap-2 form-group col-md-11"}"><button class="${"btn social btn-sm mt-2 mb-2 p-2 svelte-zs98s6"}"${add_attribute("this", googleBtnHolder, 0)}><i class="${"fa fa-google me-3 svelte-zs98s6"}"></i>
