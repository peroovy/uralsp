...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    let loading;
    if ($$props.searchQueries === void 0 && $$bindings.searchQueries && searchQueries !== void 0) $$bindings.searchQueries(searchQueries);
    if ($$props.adminId === void 0 && $$bindings.adminId && adminId !== void 0) $$bindings.adminId(adminId);
    if ($$props.usersOrErr === void 0 && $$bindings.usersOrErr && usersOrErr !== void 0) $$bindings.usersOrErr(usersOrErr);
    ...
    return `
${
    (($$result.head += `<script defer src="${"https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"}" data-svelte="svelte-5ay6di"><\/script>${
        (($$result.title = `<title>Search results</title>`), "")
    }`),
    "")
}

<div class="${"loading svelte-pvwixh"}"${add_attribute(
        "this",
        loading,
        0
    )}><div class="${"spinner-border svelte-pvwixh"}" role="${"status"}"><span class="${"visually-hidden"}">Loading...</span></div></div>
