...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let selectAllBtn = "";
  if ($$props.userInfo === void 0 && $$bindings.userInfo && userInfo !== void 0)
    $$bindings.userInfo(userInfo);
  if ($$props.competitionsInfo === void 0 && $$bindings.competitionsInfo && competitionsInfo !== void 0)
    $$bindings.competitionsInfo(competitionsInfo);
  ...
  per = permission;
  $$unsubscribe_page();
  return `${$$result.head += `<script defer src="${"https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"}" data-svelte="svelte-b3wssk"><\/script>${$$result.title = `<title>App Name| ${escape(adminName)}</title>`, ""}`, ""}
...
<section class="${"admin-container svelte-1xk55ym"}"><img class="${"d1 svelte-1xk55ym"}"${add_attribute("src", dotsSrc, 0)} alt="${""}">
	...
	<nav class="${"navbar navbar-expand-lg navbar-light mb-5 sticky-top shadow-sm svelte-1xk55ym"}"${add_attribute("this", navBar, 0)}><div class="${"container-fluid p-0 d-flex justify-content-lg-around"}"><div class="${"navbar-brand svelte-1xk55ym"}"><img${add_attribute("src", src, 0)} alt="${"Logo"}" class="${"svelte-1xk55ym"}"></div>
			...
			<div class="${"collapse navbar-collapse flex-grow-0"}" id="${"participant-menu"}"><ul class="${"navbar-nav me-auto mb-20 mb-lg-0 col-12 justify-content-around svelte-1xk55ym"}"><li class="${"nav-item svelte-1xk55ym"}"><span class="${"nav-link active"}" id="${"Users"}">Users control </span></li>
					...
					<li class="${"nav-item dropdown svelte-1xk55ym"}"><div class="${"nav-link dropdown-toggle d-flex align-items-center"}" role="${"button"}" data-bs-toggle="${"dropdown"}" aria-expanded="${"false"}"><img${add_attribute("src", tempPhoto, 0)} alt="${"Logo"}" class="${"part-photo svelte-1xk55ym"}">
							<span>${escape(adminName)}</span></div>
						<ul class="${"dropdown-menu mt-2 ms-3 rounded-0 svelte-1xk55ym"}"><li${add_classes(($page.url.pathname === "/info" ? "active" : "").trim())}><a sveltekit:prefetch href="${escape(base, true) + "/info/" + escape(real_id, true)}" content="${"Home"}" class="${"dropdown-item nav-link svelte-1xk55ym"}"><span class="${"fa fa-gears svelte-1xk55ym"}"></span>
									Settings
								</a></li>
	...
	<div class="${"sliderCont svelte-1xk55ym"}"${add_attribute("this", sliderCont, 0)}><div class="${"slide svelte-1xk55ym"}"><div class="${"container pt-5"}"><div class="${"row justify-content-center align-items-stretch shadow"}"><div class="${"form col-lg-6 p-4 m-0 svelte-1xk55ym"}"${add_attribute("this", formCont, 0)}><h1 class="${"form-header svelte-1xk55ym"}"><span class="${"fa fa-search svelte-1xk55ym"}"></span>
							Search
						</h1>
						...
						<div class="${"mb-3"}"><label for="${"region"}">Permission</label>
							<select class="${"form-select form-select-sm svelte-1xk55ym"}" aria-label="${"Default select example"}"><option selected value="${"Choose..."}">Choose...</option>${each(["default", "teacher", "admin", "super_admin"], (per2) => {
    ...
    return `<option${add_attribute("value", republic, 0)}>${escape(republic)}</option>`;
						...
						<div class="${"mb-3"}"><div class="${"form-group svelte-1xk55ym"}"><label for="${"education"}">Education type</label>
							...
							${eduType === "School" ? `<div class="${"d-flex justify-content-between p-0"}"><div class="${"row"}"><div class="${"form-group col-md-8 svelte-1xk55ym"}"><label for="${"school"}">School Name</label>
    ...
    return `<option${add_attribute("value", i + 1, 0)}>${escape(i + 1)}</option>`;
							...
							${eduType === "University" ? `<div class="${"d-flex justify-content-between p-0"}"><div class="${"row"}"><div class="${"form-group col-md-8 svelte-1xk55ym"}"><label for="${"Institute"}">Institute Name</label>
    ...
    return `<option${add_attribute("value", grade, 0)}>${escape(grade)}</option>`;
							...
							${eduType === "College" ? `<div class="${"d-flex justify-content-between p-0"}"><div class="${"row"}"><div class="${"form-group col-md-8 svelte-1xk55ym"}"><label for="${"College"}">College Name</label>
    ...
    return `<option${add_attribute("value", grade, 0)}>${escape(grade)}</option>`;
					...
					<div class="${"lottie-container col-lg-6 p-0"}"><lottie-player class="${"lottie-animations svelte-1xk55ym"}"${add_attribute("src", lottie, 0)} speed="${"1"}" loop nocontrols></lottie-player></div></div></div></div>
		<div class="${"slide svelte-1xk55ym"}"><div class="${"card menu svelte-1xk55ym"}"${add_attribute("this", filterCont, 0)}><li class="${"fa fa-filter svelte-1xk55ym"}"></li>
			...
			<div class="${"container col-12 p-0 d-flex align-items-center justify-content-center mt-5"}"><div class="${"row p-0 m-0 col-md gap-3 justify-content-center align-items-stretch"}"${add_attribute("this", compResults, 0)}><div class="${"card col-md-5 comps compt-holder p-0 col-sm-6 shadow mt-0 svelte-1xk55ym"}" style="${"max-width:500px; min-width:min-content"}"><h4 class="${"card-header"}"${add_styles({ "padding-right": `100px` })}><span class="${"fa fa-book svelte-1xk55ym"}"></span>
							Competitions
						</h4>
						<div class="${"card-body p-0 pt-1 shadow"}">${filtered.length > 0 ? `${each(filtered, (comp, i) => {
    return `${i % 2 == 0 ? `<div class="${"comp even hide d-flex flex-row align-items-stretch justify-content-between svelte-1xk55ym"}"${add_attribute("this", compsBinds[i], 0)}><span class="${"d-inline"}">${escape(comp.name)}</span>
											<i class="${"fa fa-edit m-1 svelte-1xk55ym"}"${add_attribute("id", comp.id + "", 0)} style="${"cursor:pointer; color:#3490dc"}"></i>
										</div>` : `<div class="${"comp hide d-flex flex-row align-items-stretch justify-content-between svelte-1xk55ym"}"${add_attribute("this", compsBinds[i], 0)}><span class="${"d-inline"}">${escape(comp.name)}</span>
											<i class="${"fa fa-edit m-1 svelte-1xk55ym"}"${add_attribute("id", comp.id + "", 0)} style="${"cursor:pointer; color:#3490dc"}"></i>
										</div>`}`;
						...
						<div class="${"container-fluid p-0 pt-3 bg-light d-flex justify-content-center"}"><div class="${"row col-md-6 paginationNav justify-content-center align-items-center svelte-1xk55ym"}"><ul class="${"pagination m-0 p-3 svelte-1xk55ym"}">${each(Array(Math.ceil(resultsNumber / itemPerpage)), (_, i) => {
    ...
    return `<option class="${"dropdown-item svelte-1xk55ym"}"${add_attribute("value", i, 0)}>${escape(i)}</option>`;
					...
					${selectedComp === "" ? `<div class="${"card p-0 col-md-5 svelte-1xk55ym"}" style="${"max-width:500px"}"><div class="${"card-body p-0 pt-1 shadow"}"><div class="${"noComp svelte-1xk55ym"}"><img${add_attribute("src", lottieSelect, 0)} alt="${""}" class="${"gif svelte-1xk55ym"}">
									<p class="${"svelte-1xk55ym"}">No Competition Selected, please click on <i class="${"fa fa-edit svelte-1xk55ym"}"></i>.</p></div></div></div>` : `<div class="${"card col-md-5 p-0 svelte-1xk55ym"}" style="${"min-width: fit-content"}"><div class="${"card-header"}" data-bs-toggle="${"collapse"}" href="${"#info"}" role="${"button"}" aria-expanded="${"false"}" aria-controls="${"info"}"><span class="${"fa fa-info-circle svelte-1xk55ym"}"></span>
								Information
							</div>
							...
							<div class="${"card-header d-flex justify-content-between align-items-center"}" data-bs-toggle="${"collapse"}" href="${"#applications"}" role="${"button"}" aria-expanded="${"false"}" aria-controls="${"applications"}"${add_styles({ "margin-bottom": `38px` })}><div><span class="${"fa fa-users svelte-1xk55ym"}"></span>
									Applications
								</div>
								<div><span class="${"badge badge-light text-primary"}">${escape(appLength)} available</span></div></div>
							<div class="${"card-body collapse show"}" id="${"applications"}"${add_styles({ "position": `relative` })}><div class="${"table"}"><table class="${"table table-striped table-sm svelte-1xk55ym"}"${add_styles({
    "margin-top": `-38px`,
    "margin-bottom": `100px`
    ...
    return `<tr${add_attribute("id", application.id + "", 0)} class="${"text-center"}"${add_attribute("this", applicationBinds[i], 0)}><td><li class="${"fa fa-square-o svelte-1xk55ym"}"></li></td>
    ...
    return `<option class="${"dropdown-item svelte-1xk55ym"}"${add_attribute("value", i, 0)}>${escape(i)}</option>`;
							...
							<div class="${"btn-group stickyBottom svelte-1xk55ym"}"><button class="${"btn btn-primary rounded-0 svelte-1xk55ym"}" style="${"background-color:#3490dc; border: none"}"><i class="${"fa fa-edit svelte-1xk55ym"}"></i> Edit</button>
								<button class="${"btn btn-danger rounded-0 svelte-1xk55ym"}"><i class="${"fa fa-trash svelte-1xk55ym"}"></i> Delete</button></div></div>`}</div></div></div></div>
...
<div class="${"loading svelte-1xk55ym"}"${add_attribute("this", loading, 0)}><div class="${"spinner-border svelte-1xk55ym"}" role="${"status"}"><span class="${"visually-hidden"}">Loading...</span></div>
</div>`;
});
export {
  Page as default
