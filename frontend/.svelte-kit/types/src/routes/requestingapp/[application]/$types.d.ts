...
export type PageData = Expand<
    Omit<PageParentData, keyof Kit.AwaitedProperties<Awaited<ReturnType<typeof import("../../../../../../src/routes/requestingapp/[application]/+page.js").load>>>> &
        Kit.AwaitedProperties<Awaited<ReturnType<typeof import("../../../../../../src/routes/requestingapp/[application]/+page.js").load>>>
>;
