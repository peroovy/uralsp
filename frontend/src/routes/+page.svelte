	...
	<div class="signup-form">
		...
		<div class="btn-group-vertical col-12">
			<div class="google">
				...
				<button class="btn btn-lg btn-block btn-outline" bind:this={googlePseudo}>
	...
	.signup {
		...
		.signup-form {
			...
			.btn {
				...
				.fa-vk {
					background: conic-gradient(from -45deg, #45668e 110deg, #4a76a8 90deg 180deg, #4a76a8 180deg 270deg, #4a76a8 270deg) 73% 55%/150% 150%
						no-repeat;
					-webkit-background-clip: text;
					background-clip: text;
					color: transparent;
				...
				.fa-telegram {
					background: conic-gradient(from -45deg, #0088cc 110deg, #0088cc 90deg 180deg, #0088cc 180deg 270deg, #0088cc 270deg) 73% 55%/150% 150%
						no-repeat;
					-webkit-background-clip: text;
					background-clip: text;
					color: transparent;
