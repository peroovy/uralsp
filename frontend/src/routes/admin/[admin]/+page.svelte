                            ...
                            <div class="row col-md-6 paginationNav justify-content-center align-items-center">
                                <ul class="pagination m-0 p-3">
                                    {#each Array(Math.ceil(resultsNumber / itemPerpage)) as _, i}
                                        <li class="page-item page-link" on:click={() => pagination(i)}>
                                            {i + 1}
                                        </li>
                                    {/each}
                                </ul>
                        ...
                        <div class="card p-0 col-md-5" style="max-width:500px">
                            <div class="card-body p-0 pt-1 shadow">
                                <div class="noComp">
                                    ...
                                    <p>
                                        No Competition Selected, please click on <i class="fa fa-edit" />.
                                    </p>
                                </div>
                            </div>
                        </div>
                    {:else}
                        <div class="card col-md-5 p-0" style="min-width: fit-content">
                                        ...
                                        <tbody>
                                            {#each req as application, i}
                                                <tr bind:this={applicationBinds[i]} id={application.id + ""} class="text-center">
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <button class="btn btn-success btn-sm" on:click={() => acceptApplication(application.id)}><i class="fa fa-check-square" /></button>
                                                            <button class="btn btn-danger btn-sm" on:click={() => declineApplication(application.id)}><i class="fa fa-ban" /></button>
                            ...
                            <div class="btn-group stickyBottom">
                                <button class="btn btn-primary rounded-0" style="background-color:#3490dc; border: none" on:click={() => (window.location.href = base + "contests/" + selectedCompID)}>
