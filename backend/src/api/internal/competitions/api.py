...
from api.internal.competitions.domain.services import competition_serializer, competition_service
...
def register_competitions_api(api: NinjaAPI) -> None:
    competition_handlers = CompetitionHandlers(
        competition_service, request_service, field_service, user_service, competition_serializer
    )
